                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && block == this.replaceBlock && meta == this.repmetadata)
                                {
                                    par1World.setBlock(var38, var41, var44, this.oreBlock, this.metadata, 2);
                                    
                                    //if(this.oreBlock == GSBlocks.Ores && this.metadata == 2) GalaxySpace.debug("Sap: " + var38 + " | " + var41 + " | " + var44);
                                }
                            }
                        }
                    }
