...
@Mod(
		   ...
		   dependencies = Constants.DEPENDENCIES_FORGE + "required-after:galacticraftcore@[4.0.2.211,]; required-after:galacticraftplanets; required-after:asmodeuscore@[0.0.7,)",
