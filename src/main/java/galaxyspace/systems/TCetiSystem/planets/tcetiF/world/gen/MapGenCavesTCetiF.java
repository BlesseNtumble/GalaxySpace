...
public class MapGenCavesTCetiF extends MapGenBaseMeta
{
    public static final int BREAK_THROUGH_CHANCE = 24; // 1 in n chance
                            ...
                            for (int localX = l1; localX < i2; localX++)
                            {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        {
                                            if (blockIdArray[coords] == TCBlocks.TCetiEBlocks && metaArray[coords] == 1 && random.nextInt(MapGenCavesTCetiF.BREAK_THROUGH_CHANCE) == 0)
                                            {
                                                    blockIdArray[coords] = Blocks.water;
                                            }
                                            else if (blockIdArray[coords] == TCBlocks.TCetiEBlocks && metaArray[coords] == 2)
                                            {
                                                    blockIdArray[coords] = Blocks.water;
                                            }
