...
public class CloudProviderTCetiF extends IRenderHandler
{
	private static Minecraft mc;
	private static final ResourceLocation locationCloudsPng = new ResourceLocation("textures/environment/clouds.png");
	public static int cloudTickCounter = 0;

	public CloudProviderTCetiF()
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		float f1 = (float)(CloudProviderTCetiF.mc.renderViewEntity.lastTickPosY + (CloudProviderTCetiF.mc.renderViewEntity.posY - CloudProviderTCetiF.mc.renderViewEntity.lastTickPosY) * partialTicks);
		...
		for (int count = 0; count < 1; ++count)
		{
			...
			for (int k = 0; k < 2; ++k)
			{
				...
				else if (CloudProviderTCetiF.mc.gameSettings.anaglyph)
				{
				...
				double d1 = (CloudProviderTCetiF.mc.renderViewEntity.prevPosX + (CloudProviderTCetiF.mc.renderViewEntity.posX - CloudProviderTCetiF.mc.renderViewEntity.prevPosX) * partialTicks + d0 * 0.029999999329447746D) / f2;
				double d2 = (CloudProviderTCetiF.mc.renderViewEntity.prevPosZ + (CloudProviderTCetiF.mc.renderViewEntity.posZ - CloudProviderTCetiF.mc.renderViewEntity.prevPosZ) * partialTicks) / f2 + 0.33000001311302185D;
				...
				float f5 = 230.0F / (1200.0F + count * 300.0F);
				float f6 = 230.0F / (1200.0F + count * 300.0F);
				float f7 = 230.0F / (1200.0F + count * 300.0F);
				float f8;
				float f9;
				float f10;

				if (CloudProviderTCetiF.mc.gameSettings.anaglyph)
				{
