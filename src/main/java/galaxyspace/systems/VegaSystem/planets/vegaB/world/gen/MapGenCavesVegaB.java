...
public class MapGenCavesVegaB extends MapGenBaseMeta
{
                            ...
                            for (int localX = l1; localX < i2; localX++)
                            {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        {
                                            if (blockIdArray[coords] == VGBlocks.VegaBGrunt && random.nextInt(MapGenCavesVegaB.BREAK_THROUGH_CHANCE) == 0)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
                                            else if (blockIdArray[coords] == VGBlocks.VegaBSubGrunt);
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
