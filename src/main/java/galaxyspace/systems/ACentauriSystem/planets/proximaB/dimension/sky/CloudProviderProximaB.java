...
public class CloudProviderProximaB extends IRenderHandler
{
	private static Minecraft mc;
	private static final ResourceLocation locationCloudsPng = new ResourceLocation("textures/environment/clouds.png");
	public static int cloudTickCounter = 0;
	
	public CloudProviderProximaB()
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		float f1 = (float)(this.mc.renderViewEntity.lastTickPosY + (this.mc.renderViewEntity.posY - this.mc.renderViewEntity.lastTickPosY) * partialTicks);
		...
		for (int count = 0; count < 3; ++count)
		{
			...
			for (int k = 0; k < 2; ++k)
			{
				...
				double d1 = (this.mc.renderViewEntity.prevPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * partialTicks + d0 * 0.029999999329447746D) / f2;
				double d2 = (this.mc.renderViewEntity.prevPosZ + (this.mc.renderViewEntity.posZ - this.mc.renderViewEntity.prevPosZ) * partialTicks) / f2 + 0.33000001311302185D;
				...
				//TODO Color
				float f5 = 134.0F / (1200.0F + count * 300.0F);
				float f6 = 147.0F / (1200.0F + count * 300.0F);
				float f7 = 128.0F / (1200.0F + count * 300.0F);
				float f8;
				float f9;
				float f10;
