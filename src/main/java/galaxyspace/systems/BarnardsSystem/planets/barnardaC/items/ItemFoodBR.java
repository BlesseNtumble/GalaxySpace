...
public class ItemFoodBR extends ItemFood {

	public static String[] names = { "yellow_fruits" };
	...
	public ItemFoodBR() {
        ...
        this.setUnlocalizedName("br_food");
	}
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
        ...
        {
            this.icons[i++] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "barnarda/food/" + name);
        }
    }
