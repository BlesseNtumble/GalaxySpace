...
import galaxyspace.systems.BarnardsSystem.planets.barnardaC.world.gen.layer.GenLayerBarnardaC;
...
public class WorldChunkManagerBarnardaC extends WorldChunkManagerSpace {
	...
	public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(
			Arrays.asList(
					GSBiomeGenBase.GSSpace,					
					GSBiomeGenBase.GSSpaceLowPlains,
					GSBiomeGenBase.GSSpaceDeepOceans,
					GSBiomeGenBase.GSSpaceOceans
			)
	);
	...
	protected WorldChunkManagerBarnardaC()
	{
		...
		this.myBiomesToSpawnIn.addAll(allowedBiomes);
	}

	public WorldChunkManagerBarnardaC(long seed, WorldType worldtype)
	{
		this();
		GenLayer[] agenlayer;
		agenlayer = GenLayerBarnardaC.makeTheWorld(seed, worldtype);
