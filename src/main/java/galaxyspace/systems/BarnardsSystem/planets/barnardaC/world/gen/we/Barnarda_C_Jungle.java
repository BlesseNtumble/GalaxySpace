...
public class Barnarda_C_Jungle extends WE_Biome {
	...
	public Barnarda_C_Jungle(double min, double max) {
		...
		this.spawnableCreatureList.add(new SpawnListEntry(EntityOcelot.class, 3, 1, 2));
		...
		standardBiomeLayers.add(BRBlocks.BarnardaCGrass, (byte)3, BRBlocks.BarnardaCBlocks, (byte)0, -256, 0, -256,  0, false);
