...
public class ItemMarsRover extends Item implements IHoldableItem, ISortableItem
{
        ...
        else
        {
            ...
            else
            {
                if (var24.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    ...
                    final EntityMarsRover var35 = new EntityMarsRover(worldIn, var29 + 0.5F, var33 + 1.0F, var34 + 0.5F, itemstack.getItemDamage());
    ...
    {
    	tooltip.add(EnumColor.DARK_RED + "[WIP] Content");
        ...
        {
            tooltip.add(GCCoreUtil.translate("gui.message.fuel.name") + ": " + par1ItemStack.getTagCompound().getInteger("BuggyFuel") + " / " + EntityMarsRover.tankCapacity);
        }
    }
