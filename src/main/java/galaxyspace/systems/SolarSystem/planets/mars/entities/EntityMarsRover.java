package galaxyspace.systems.SolarSystem.planets.mars.entities;
...
public class EntityMarsRover extends Entity implements ICameraZoomEntity, IInventory, IPacketReceiver, IDockable, IControllableEntity, IEntityFullSync
{
    private static final DataParameter<Integer> CURRENT_DAMAGE = EntityDataManager.createKey(EntityMarsRover.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(EntityMarsRover.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> ROCK_DIRECTION = EntityDataManager.createKey(EntityMarsRover.class, DataSerializers.VARINT);
    public static final int tankCapacity = 3000;
    ...
    public EntityMarsRover(World var1, double var2, double var4, double var6, int type)
    {
        this(var1);
