...
public class SkyProviderMars extends IRenderHandler
{
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        {
        	FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderBase.pumpkinsunTexture);
        }
        else mc.renderEngine.bindTexture(SkyProviderMars.sunTexture);
        tessellator1.startDrawingQuads();
     ...
     // Render deimos
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMars.lmcTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
     ...
     // Render Small Magellanic Cloud
        f10 = 5.0F;
        GL11.glScalef(0.6F, 0.6F, 0.6F);
        GL11.glRotatef(-45.0F, 0.0F, 1.0F, 0.0F); //������������ �� X
        GL11.glRotatef(-105F, 1.0F, 0.0F, 0.0F); //������������ �� Y
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMars.smcTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
     ...
     // Render Andromeda
        f10 = 3.0F;
        GL11.glScalef(0.6F, 0.6F, 0.6F);
        GL11.glRotatef(145.0F, 0.0F, 1.0F, 0.0F); //������������ �� X
        GL11.glRotatef(-135F, 1.0F, 0.0F, 0.0F); //������������ �� Y
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMars.andromedaTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glPushMatrix();
        /*
        // Render Barnarda Loop
        f10 = 40.0F;
        GL11.glScalef(0.6F, 0.6F, 0.6F);
        GL11.glRotatef(65.0F, 0.0F, 1.0F, 0.0F); //������������ �� X
        GL11.glRotatef(-135F, 1.0F, 0.0F, 0.0F); //������������ �� Y
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.barnardaloopTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
