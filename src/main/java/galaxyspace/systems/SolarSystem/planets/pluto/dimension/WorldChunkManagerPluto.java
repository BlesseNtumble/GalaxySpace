...
import galaxyspace.systems.SolarSystem.planets.pluto.world.gen.layer.GenLayerPluto;
...
public class WorldChunkManagerPluto extends WorldChunkManagerSpace {
	...
	protected WorldChunkManagerPluto()
	{
		...
		this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills);
		this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains);
	}
	...
	public WorldChunkManagerPluto(long seed)
	{
		this();
		GenLayer[] agenlayer;
		agenlayer = GenLayerPluto.makeTheWorld(seed);
