                            ...
                            for (int localX = l1; localX < i2; localX++)
                            {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        {
                                            if (blockIdArray[coords] == GSBlocks.PlutoBlocks || metaArray[coords] == 0 || metaArray[coords] == 1 || metaArray[coords] == 2  || metaArray[coords] == 3 && random.nextInt(MapGenCavesPluto.BREAK_THROUGH_CHANCE) == 0)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
                                            else if (blockIdArray[coords] == GSBlocks.PlutoBlocks && metaArray[coords] == 4)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
                                            else if (blockIdArray[coords] == GSBlocks.PlutoBlocks && metaArray[coords] == 5)
                                            {
                                                    blockIdArray[coords] = Blocks.air;
                                            }
