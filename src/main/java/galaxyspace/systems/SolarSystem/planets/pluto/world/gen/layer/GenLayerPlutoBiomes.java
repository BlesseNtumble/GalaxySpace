package galaxyspace.systems.SolarSystem.planets.pluto.world.gen.layer;
...
{
	protected BiomeGenBase[] commonBiomes = { GSBiomeGenBase.GSSpace, GSBiomeGenBase.GSSpaceLowPlains, GSBiomeGenBase.GSSpaceLowHills, GSBiomeGenBase.GSSpaceMidPlains};
	protected BiomeGenBase[] rareBiomes = { GSBiomeGenBase.GSSpace };

	public GenLayerPlutoBiomes(long seed, GenLayer genlayer)
	{
		super(seed);
		this.parent = genlayer;
	}

	public GenLayerPlutoBiomes(long seed)
	{
		super(seed);
	}
