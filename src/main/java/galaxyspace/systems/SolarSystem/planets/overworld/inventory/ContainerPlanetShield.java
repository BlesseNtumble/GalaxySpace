...
public class ContainerPlanetShield extends Container
{
    private TileEntityPlanetShield tileEntity;

    public ContainerPlanetShield(InventoryPlayer par1InventoryPlayer, TileEntityPlanetShield tileEntity)
    {
        this.tileEntity = tileEntity;

        // Battery Slot
        this.addSlotToContainer(new SlotSpecific(tileEntity, 0, 79, 101, ItemElectricBase.class));
        this.addSlotToContainer(new SlotFurnaceOutput(par1InventoryPlayer.player, tileEntity, 5, 80, 17));
