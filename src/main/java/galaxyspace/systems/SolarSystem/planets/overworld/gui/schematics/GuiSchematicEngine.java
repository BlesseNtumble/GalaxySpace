...
public class GuiSchematicEngine extends GuiContainerGC implements ISchematicResultPage
{
    ...
    private static final ResourceLocation BodyTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/gui/schematics/schematic_parts.png");

    private int pageIndex;

    public GuiSchematicEngine(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicEngine(par1InventoryPlayer, x, y, z));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.RocketEngine.name"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        final int var6 = (this.height - this.ySize) / 2;      
	       ...
	       this.mc.renderEngine.bindTexture(this.BodyTexture);
	       this.drawTexturedModalRect(var5 + 123, var6 + 50, 98, 0, 52, 42);        
