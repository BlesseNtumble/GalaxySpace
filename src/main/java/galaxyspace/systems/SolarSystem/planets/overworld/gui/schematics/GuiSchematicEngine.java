...
public class GuiSchematicEngine extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicEngine(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        super(new ContainerSchematicEngine(par1InventoryPlayer, pos));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.rocket_engine.name"), 7, -20 + 27, 4210752);
