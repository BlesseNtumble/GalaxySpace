...
public class ContainerSchematicFins extends Container
{
    ...
    public ContainerSchematicFins(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        for (var6 = 0; var6 < 2; ++var6)
        {
        	for (var7 = 0; var7 < 2; ++var7)            
       		this.addSlotToContainer(new SlotSchematicFins(this.craftMatrix, var6 + var7 * 2 + 1, 35 + var7 * 19, 30 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
        ...
        for (var6 = 0; var6 < 2; ++var6)
        {
        	for (var7 = 0; var7 < 4; ++var7)            
       		this.addSlotToContainer(new SlotSchematicFins(this.craftMatrix, var6 + var7 * 2 + 5, 16 + var7 * 19, 68 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
