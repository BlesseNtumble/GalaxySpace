...
public class SchematicBodyRecipe {
	...
	public static void registerRecipeWorkBench()
    {
		for(int k = 0; k <= 3; k++)
        {
			...
			input.put(9, plate);
			input.put(10, new ItemStack(GSItems.RocketModules, 1, 3));
			input.put(11, new ItemStack(GSItems.RocketModules, 1, 3));
			
			input.put(12, new ItemStack(AsteroidsItems.basicItem, 1, 1));

			input.put(13, new ItemStack(GCItems.basicItem, 1, 14));
			input.put(14, new ItemStack(GCItems.oxygenConcentrator, 1, 0));
			input.put(15, plate);
			input.put(16, new ItemStack(GSItems.RocketModules, 1, 3));
			input.put(17, new ItemStack(GSItems.RocketModules, 1, 3));

			input.put(18, new ItemStack(AsteroidsItems.basicItem, 1, 1));
			...
			input.put(23, plate);
			input.put(24, plate);
			GSRecipeUtil.addBodyRecipe(new NasaWorkbenchRecipe(new ItemStack(GSItems.RocketParts, 1, k*5 + 1), input));
        }
    }
}
