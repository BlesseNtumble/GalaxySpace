...
public class BlockGasCollector extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public BlockGasCollector()
    {
        ...
        this.setUnlocalizedName("gas_collector");
    ...
    {
    	TileEntityGasCollector tile = (TileEntityGasCollector) world.getTileEntity(pos);
