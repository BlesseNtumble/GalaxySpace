...
public class ContainerSolarWind extends Container
{
    private TileEntitySolarWind tileEntity;

    public ContainerSolarWind(InventoryPlayer par1InventoryPlayer, TileEntitySolarWind solarGen)
    {
