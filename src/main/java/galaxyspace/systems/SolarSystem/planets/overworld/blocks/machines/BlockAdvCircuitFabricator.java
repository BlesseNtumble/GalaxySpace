...
public class BlockAdvCircuitFabricator extends BlockAdvancedTile implements IShiftDescription, ISortableBlock{

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    
	public BlockAdvCircuitFabricator()
    {
        super(GCBlocks.machine);
        this.setUnlocalizedName("adv_circuit_fabricator");
    ...
    {
        return new TileEntityAdvCircuitFabricator();
    }
