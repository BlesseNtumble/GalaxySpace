...
public class TileEntityCargoFluidUnloader extends TileBaseElectricBlockWithInventory implements ISidedInventory, ILandingPadAttachable
{
    ...
    public TileEntityCargoFluidUnloader()
    {
    ...
    {
        return GCCoreUtil.translate("container.cargofluidunloader.name");
    }
