...
public class GuiGravitationModule extends GuiContainerGC implements ITextBoxCallback, ICheckBoxCallback
{
    ...
    public void initGui()
    {
        ...
        this.infoRegions.add(new GuiElementInfoRegion((this.width - this.xSize) / 2 + 76, (this.height - this.ySize) / 2 + 101, 18, 18, batterySlotDesc, this.width, this.height, this));
        ...
        this.checkboxRenderEffects = new GuiElementCheckbox(0, this, var5 + 14, var6 + 65, EnumColor.WHITE + GCCoreUtil.translate("gui.message.effectVisible.name"));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
    	...
    	this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("gui.gravity.radius.name"), 30, 46, 4210752);
        ...
        if (this.tileEntity.hasEnoughEnergyToRun && !this.tileEntity.disabled)
        {
        ...
        disableButton.displayString = this.tileEntity.disabled ? GCCoreUtil.translate("gui.button.enable.name") : GCCoreUtil.translate("gui.button.disable.name");

        


        this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("gui.message.status.name") + ": " + displayText, 100, 104, 4210752);
        this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("container.inventory"), 18, this.ySize - 89, 4210752);
  
        if(this.inventorySlots.getSlot(1).getHasStack()) 
        	this.fontRendererObj.drawString(EnumColor.BRIGHT_GREEN + GCCoreUtil.translate("gui.message.active_pressure_shield.name"), 30, 24, 4210752);
...
/*
	...
	public void onSelectionChanged(GuiElementCheckbox checkbox, boolean newSelected) {
        ...
        GalaxySpace.packetPipeline.sendToServer(new GSPacketSimple(GSEnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, new Object[] { 6, this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord, newSelected ? 1 : 0 }));
	...
	protected void sendDataToServer()
    {
        ...
        GalaxySpace.packetPipeline.sendToServer(new GSPacketSimple(GSEnumSimplePacket.S_GRAVITY_RADIUS, pos, actualStrength));
