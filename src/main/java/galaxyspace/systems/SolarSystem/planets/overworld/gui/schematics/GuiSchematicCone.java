...
implements ISchematicResultPage {
    ...
    public GuiSchematicCone(InventoryPlayer par1InventoryPlayer, int x, int y, int z) {
        super((Container)new ContainerSchematicCone(par1InventoryPlayer, x, y, z));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString(EnumColor.WHITE + GSItems.RocketParts.getItemStackDisplayName(new ItemStack(GSItems.RocketParts, 1, 0)), 7, 7, 0x404040);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        this.mc.renderEngine.bindTexture(ConeTexture);
