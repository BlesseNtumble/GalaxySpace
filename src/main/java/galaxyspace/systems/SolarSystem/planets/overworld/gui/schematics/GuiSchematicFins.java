...
public class GuiSchematicFins extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicFins(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        super(new ContainerSchematicFins(par1InventoryPlayer, pos));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.rocket_stabiliser.name"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
	    ...
	    this.mc.renderEngine.bindTexture(this.FinsTexture);
