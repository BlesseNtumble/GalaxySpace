...
public class BlockAdvOxygenSealer extends BlockAdvancedTile implements ItemBlockDesc.IBlockShiftDesc
{
    ...
    public BlockAdvOxygenSealer(String assetName)
    {
        super(Material.rock);
    ...
    {
        return new TileEntityAdvOxygenSealer();
    }
