...
public class BlockModificationTable extends BlockTileGC implements IBlockShiftDesc{
	...
	public BlockModificationTable() {
		...
		this.setBlockName("ModificationTable");
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        this.iconFront = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" +  "overworld/modification_table");
    }
