...
public class BlockAdvWindGenerator extends BlockAdvancedTile implements IShiftDescription, ISortableBlock{

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	   
	public BlockAdvWindGenerator() {
		super(GCBlocks.machine);
		this.setHardness(1.0F);
		this.setSoundType(SoundType.METAL);
		this.setTranslationKey("adv_wind_generator");
	}
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (var9 instanceof TileEntityWindGenerator)
        {
            ((TileEntityWindGenerator) var9).onDestroy(var9);
        }
    ...
    {
        return new TileEntityWindGenerator(true);
    }
