...
public class BlockUniversalRecycler extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	   
	public BlockUniversalRecycler()
    {
        super(GCBlocks.machine);
        this.setUnlocalizedName("universal_recycler");
    ...
    {
        return new TileEntityUniversalRecycler();
    }
