...
public class ContainerSchematicOxTank extends Container
{
    public InventorySchematicOxTank craftMatrix = new InventorySchematicOxTank(this);
    public IInventory craftResult = new InventoryCraftResult();
    private final World worldObj;

    public ContainerSchematicOxTank(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        final int change = 27;
        ...
        for (var6 = 0; var6 < 4; ++var6)
        {
        	for (var7 = 0; var7 < 3; ++var7)            
       		this.addSlotToContainer(new SlotSchematicOxTank(this.craftMatrix, var6 + var7 * 4 + 1, 26 + var7 * 19, 26 + var6 * 19 + change, pos, par1InventoryPlayer.player));
        }
    ...
    {
    	this.craftResult.setInventorySlotContents(0, GSUtils.findMatchingNASARecipe(GSRecipeUtil.getOxTankRecipes(), this.craftMatrix));
    }
