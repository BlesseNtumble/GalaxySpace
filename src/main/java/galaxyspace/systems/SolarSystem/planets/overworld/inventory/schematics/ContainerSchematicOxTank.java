...
public class ContainerSchematicOxTank extends Container
{
    ...
    public ContainerSchematicOxTank(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        for (var6 = 0; var6 < 4; ++var6)
        {
        	for (var7 = 0; var7 < 3; ++var7)            
       		this.addSlotToContainer(new SlotSchematicOxTank(this.craftMatrix, var6 + var7 * 4 + 1, 26 + var7 * 19, 18 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
    ...
    {
        this.craftResult.setInventorySlotContents(0, GSRecipeUtil.findMatchingOxTankRecipe(this.craftMatrix));
    }
