...
public class BlockLiquidSeparator extends BlockTileGC implements IBlockShiftDesc{

	public static final int LIQUID_SEPARATOR_METADATA = 0;
	
	private IIcon iconMachineSide;
    private IIcon iconOutput;
    private IIcon iconInput;
    private IIcon[] iconLiquidExtractor = new IIcon[3];
    
    public BlockLiquidSeparator()
    {
        super(GCBlocks.machine);
        this.setBlockName("LiquidSeparator");
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        this.iconLiquidExtractor[0] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/liquid_separator");
        this.iconLiquidExtractor[1] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/machine_luqiudextractor_bottom");
        this.iconLiquidExtractor[2] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/machine_water_input");
    }
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
    {
        ...
        {
           return this.iconLiquidExtractor[0];
        }
    ...
    public IIcon getIcon(int side, int metadata)
    {
        if (side == 1)
        {
            return this.iconLiquidExtractor[2];
        }
        
        if(side == 0)
        	return this.iconInput;
        
        if (metadata >= this.LIQUID_SEPARATOR_METADATA)
        {
    ...
    public TileEntity createTileEntity(World world, int metadata)
    {
        ...
        if (metadata == this.LIQUID_SEPARATOR_METADATA)
        {
            return new TileEntityLiquidSeparator();
        }
		return null;
    }
    ...
    {
        return new ItemStack(this, 1, this.LIQUID_SEPARATOR_METADATA);
    }
    ...
    {
    	return GCCoreUtil.translate("tile.LiquidSeparator.desc");
    }
