...
public class TileEntityStorageModule extends TileBaseUniversalElectricalSource implements IPacketReceiver, ISidedInventory, IConnector
{
    private final static float TIER3_CAPACITY = 5000000;
    private final static float TIER4_CAPACITY = 10000000;
    ...
    public TileEntityStorageModule(int tier)
    {
        ...
        if (tier == 1)
        {
            ...
            this.storage.setCapacity(TIER3_CAPACITY);
            this.storage.setMaxExtract(2200);
            return;
        }
    ...
    {
        this.storage.setCapacity(TIER4_CAPACITY);
        this.storage.setMaxExtract(3400);
        this.setTierGC(2);  	
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (this.storage.getEnergyStoredGC() > TIER3_CAPACITY)
        {
        	this.setTier2();
            this.initialised = true;
        }
    ...
    {
        if (this.tierGC == 1 && this.storage.getEnergyStoredGC() > TIER3_CAPACITY)
        	this.storage.setEnergyStored(TIER3_CAPACITY);
    ...
    {
        return GCCoreUtil.translate(this.tierGC == 1 ? "tile.StorageModuleT3_4.name" : "tile.storagemodule_t4.name");
    }
