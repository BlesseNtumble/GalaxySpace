...
public class BlockLiquidExtractor extends BlockTileGC implements IBlockShiftDesc{

	public static final int LIQUID_EXTRACTOR_METADATA = 0;
	
	private IIcon iconMachineSide;
    private IIcon iconOutput;
    private IIcon iconInput;
    private IIcon[] iconLiquidExtractor = new IIcon[2];
    
    public BlockLiquidExtractor()
    {
        super(GCBlocks.machine);
        this.setBlockName("LiquidExtractor");
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        this.iconLiquidExtractor[0] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/liquid_extractor");
    ...
    public IIcon getIcon(int side, int metadata)
    {
        ...
        if(side == 0)
        	return this.iconLiquidExtractor[1];
        
        if (metadata >= this.LIQUID_EXTRACTOR_METADATA)
        {
    ...
    public TileEntity createTileEntity(World world, int metadata)
    {
        ...
        if (metadata == this.LIQUID_EXTRACTOR_METADATA)
        {
            return new TileEntityLiquidExtractor();
        }
		return null;
    }
    ...
    {
        return new ItemStack(this, 1, this.LIQUID_EXTRACTOR_METADATA);
    }
    ...
    {
    	return GCCoreUtil.translate("tile.LiquidExtractor.desc");
    }
