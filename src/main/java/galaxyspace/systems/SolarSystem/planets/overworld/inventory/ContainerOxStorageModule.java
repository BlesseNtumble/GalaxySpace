...
public class ContainerOxStorageModule extends Container
{
    private TileEntityOxStorageModule tileEntity;

    public ContainerOxStorageModule(InventoryPlayer par1InventoryPlayer, TileEntityOxStorageModule storageModule)
    {
