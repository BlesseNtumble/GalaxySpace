...
public class BlockAdvLandingPadFull extends BlockAdvancedTile implements IPartialSealableBlock
{
    private IIcon[] icons = new IIcon[3];

    public BlockAdvLandingPadFull(String assetName)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(GSBlocks.AdvLandingPad);
    }
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z)
    {
        ...
        return new ItemStack(Item.getItemFromBlock(GSBlocks.AdvLandingPad), 1, metadata);
    }
}
