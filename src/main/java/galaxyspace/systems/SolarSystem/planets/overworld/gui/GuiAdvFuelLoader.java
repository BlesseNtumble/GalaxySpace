...
public class GuiAdvFuelLoader extends GuiContainerGC
{
    ...
    private final TileEntityAdvFuelLoader fuelLoader;
    ...
    public GuiAdvFuelLoader(InventoryPlayer par1InventoryPlayer, TileEntityAdvFuelLoader par2TileEntityAirDistributor)
    {
        super(new ContainerAdvFuelLoader(par1InventoryPlayer, par2TileEntityAirDistributor));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.mc.getTextureManager().bindTexture(GuiAdvFuelLoader.fuelLoaderTexture);
        ...
        FluidStack fluid = this.fuelLoader.fuelTank.getFluid();        
        if(fluid != null)
        {
	        GL11.glPushMatrix();	        
	        GSUtils.drawFluid(fluid, var5 + 7, var6 + 33, 16, 38, this.fuelLoader.fuelTank.getCapacity());
			GL11.glPopMatrix();
        }
        this.mc.getTextureManager().bindTexture(GuiAdvFuelLoader.fuelLoaderTexture);
