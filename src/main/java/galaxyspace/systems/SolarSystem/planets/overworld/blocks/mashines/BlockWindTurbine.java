...
public class BlockWindTurbine extends BlockTileGC implements IBlockShiftDesc, IPartialSealableBlock
{
    ...
    public BlockWindTurbine(String assetName)
    {
        super(Material.iron);
    ...
    {
        par3List.add(new ItemStack(par1, 1, BlockWindTurbine.BASE_METADATA));
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.icons[1] = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/solarwind_basic_1");
    ...
    public IIcon getIcon(int side, int meta)
    {
       /* if (meta >= BlockSolarPanel.ULTRA_METADATA)
        ...
        else*/ if (meta >= BlockWindTurbine.BASE_METADATA)
        {
            int shiftedMeta = meta -= BlockWindTurbine.BASE_METADATA;
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
       ...
       /* if (metadata >= BlockWindTurbine.ULTRA_METADATA)
        {
            world.setBlockMetadataWithNotify(x, y, z, BlockWindTurbine.ULTRA_METADATA + change, 3);
        }
        else
        {*/
            world.setBlockMetadataWithNotify(x, y, z, BlockWindTurbine.BASE_METADATA + change, 3);
        //}
        ...
        {
            ((TileEntityWindTurbine) tile).onCreate(new BlockVec3(x, y, z));
        }
    }
    ...
    public void breakBlock(World var1, int var2, int var3, int var4, Block var5, int var6)
    {
        ...
        if (var9 instanceof TileEntityWindTurbine)
        {
            ((TileEntityWindTurbine) var9).onDestroy(var9);
        }
...
/*
        if (metadata >= BlockWindTurbine.ULTRA_METADATA)
        {
            original -= BlockWindTurbine.ULTRA_METADATA;
        }*/
...
/*
        if (metadata >= BlockWindTurbine.ULTRA_METADATA)
        {
            change += BlockWindTurbine.ULTRA_METADATA;
        }*/
    ...
    public int damageDropped(int metadata)
    {
      /*  if (metadata >= BlockWindTurbine.ULTRA_METADATA)
        {
            return BlockWindTurbine.ULTRA_METADATA;
        }
        else
        {*/
            return BlockWindTurbine.BASE_METADATA;
        //}
    }
    ...
    public TileEntity createTileEntity(World world, int metadata)
    {
       /* if (metadata >= BlockWindTurbine.ULTRA_METADATA)
        {
            return new TileEntityWindTurbine(2);
        }
        else
        {*/
            return new TileEntityWindTurbine(1);
        //}
    }
    ...
    public String getShiftDescription(int meta)
    {
        ...
        {
        case BASE_METADATA:
            return GCCoreUtil.translate("tile.WindTurbine.desc");
        //case ULTRA_METADATA:
	...
	public String getDescription(int meta) {
		return GCCoreUtil.translate("tile.coefficient.desc") + ": x" + GSConfigEnergy.coefficientWindTurbine;
	}
}
