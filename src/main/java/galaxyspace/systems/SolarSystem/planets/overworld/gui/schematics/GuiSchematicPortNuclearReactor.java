...
public class GuiSchematicPortNuclearReactor extends GuiContainerGC implements ISchematicResultPage
{
    ...
    private static final ResourceLocation PartTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/gui/schematics/schematic_parts.png");

    private int pageIndex;

    public GuiSchematicPortNuclearReactor(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicPortNuclearReactor(par1InventoryPlayer, x, y, z));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRendererObj.drawString(EnumColor.WHITE + GSBlocks.PortableNuclearReactor.getLocalizedName(), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
	    ...
	    this.mc.renderEngine.bindTexture(this.PartTexture);
	    this.drawTexturedModalRect(var5 + 120, var6 + 37, 45, 58, 52, 64);  
