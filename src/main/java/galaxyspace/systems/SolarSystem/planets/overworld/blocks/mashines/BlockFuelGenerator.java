...
implements GSItemBlockDesc.IBlockShiftDesc {
    public static final int FUEL_GENERATOR_METADATA = 0;
    private IIcon iconMachineSide;
    private IIcon iconOutput;
    private IIcon iconFuelOutput;
    private IIcon[] iconFuelGenerator = new IIcon[2];

    public BlockFuelGenerator(String assetName) {
    ...
    public String getDescription(int meta) {
        return GCCoreUtil.translate((String)"tile.coefficient.desc") + ": x" + GSConfigEnergy.coefficientFuelGenerator;
    }

    @Override
    public String getShiftDescription(int meta) {
        return GCCoreUtil.translate((String)"tile.FuelGenerator.desc");
    }
