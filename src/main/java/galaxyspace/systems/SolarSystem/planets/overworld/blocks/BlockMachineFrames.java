...
public class BlockMachineFrames extends Block implements ITerraformableBlock
{
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
	   	...
	   	this.textures[0] = iconRegister.registerIcon(GalacticraftCore.TEXTURE_PREFIX + "machine");
	   	this.textures[1] = iconRegister.registerIcon("galacticraftasteroids:machine");
		this.textures[2] = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/machine");
	}
	...
	public void getSubBlocks(Item block, CreativeTabs creativeTabs, List list)
	{
		...
		{
			if(i != 1) list.add(new ItemStack(block, 1, i));
		}
	}
}