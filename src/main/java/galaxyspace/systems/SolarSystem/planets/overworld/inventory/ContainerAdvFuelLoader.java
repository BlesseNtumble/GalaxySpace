...
public class ContainerAdvFuelLoader extends Container
{
    private TileBaseElectricBlock tileEntity;

    public ContainerAdvFuelLoader(InventoryPlayer par1InventoryPlayer, TileEntityAdvFuelLoader fuelLoader)
    {
