...
public class ItemCargoFluidRocket extends Item implements IHoldableItem
{
    public ItemCargoFluidRocket()
    {
        super();
        this.setMaxDamage(0);
        this.setHasSubtypes(true);
        this.setMaxStackSize(1);
        this.setUnlocalizedName("CargoFluidRocket");
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (padFound)
            {
                ...
                rocket = new EntityCargoFluidRocket(par3World, centerX, centerY, centerZ, EnumRocketType.values()[par1ItemStack.getItemDamage()]);
                ...
                {
                    ((EntityCargoFluidRocket) rocket).fuelTank.fill(new FluidStack(GalacticraftCore.fluidFuel, rocket.getMaxFuel()), true);
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par2List, boolean b)
    {
        ...
        if (!type.getTooltip().isEmpty())
        {
        	...
        	//par2List.add(GCCoreUtil.translate("gui.message.cargofluid.name") +  ((EntityCargoFluidRocket) rocket).getCargoTankCapacity());
        ...
        {
            EntityAutoRocket rocket;
            rocket = new EntityCargoFluidRocket(FMLClientHandler.instance().getWorldClient(), 0, 0, 0, EnumRocketType.values()[par1ItemStack.getItemDamage()]);
        
            par2List.add(GCCoreUtil.translate("gui.message.cargofluid.name") + rocket.getFuelTankCapacity());
        ...
        if(type.getIndex() != 4)
        	par2List.add(GCCoreUtil.translate("gui.message.cargofluid.name") + " " + 8000 * (type.getIndex() + 1));
    ...
    {
        return super.getUnlocalizedName(par1ItemStack) + ".cargoRocket";
    }
