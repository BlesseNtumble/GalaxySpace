...
public class GuiSchematicTier2Rocket extends GuiContainerGC implements ISchematicResultPage
{
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + MarsItems.rocketMars.getItemStackDisplayName(new ItemStack(MarsItems.rocketMars, 1, 0)), 7, -20 + 27, 4210752);
