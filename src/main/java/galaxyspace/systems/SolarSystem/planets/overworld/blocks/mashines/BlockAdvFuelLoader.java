...
public class BlockAdvFuelLoader extends BlockAdvancedTile implements IBlockShiftDesc
{
    ...
    public BlockAdvFuelLoader(String assetName)
    {
        super(Material.rock);
    ...
    {
        this.iconInput = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/machine_input");
        this.iconMachineSide = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX  + ":" + "overworld/machine");
        this.iconFront = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX  + ":" + "overworld/advfuelloader");
        this.iconFuelInput = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX  + ":" + "overworld/machine_fuel_input");
    }

    @Override
    public TileEntity createTileEntity(World world, int metadata)
    {
        return new TileEntityAdvFuelLoader();
    }
