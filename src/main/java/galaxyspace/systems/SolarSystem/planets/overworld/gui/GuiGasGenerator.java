...
public class GuiGasGenerator extends GuiTileBase
{
    ...
    public GuiGasGenerator(InventoryPlayer par1InventoryPlayer, TileEntityGasGenerator tileEntity)
    {
        super(new ContainerGasGenerator(par1InventoryPlayer, tileEntity), 2, 1);
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        {
            displayText = (getStyle() == Style.CLASSIC ? EnumColor.DARK_GREEN : EnumColor.BRIGHT_GREEN) + GCCoreUtil.translate("gui.status.generating.name") + " " +  EnergyDisplayHelper.getEnergyDisplayS(this.tileEntity.heatGJperTick) + "/t";
        }
