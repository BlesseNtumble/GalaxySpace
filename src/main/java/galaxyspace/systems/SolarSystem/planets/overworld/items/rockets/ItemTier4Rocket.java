...
public class ItemTier4Rocket extends Item implements IHoldableItem
{
    public ItemTier4Rocket()
    {
        super();
        this.setMaxDamage(0);
        this.setHasSubtypes(true);
        this.setMaxStackSize(1);
        this.setUnlocalizedName("Tier4Rocket");
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (padFound)
            {
                ...
                rocket.setPosition(rocket.posX - 0.5, rocket.posY + rocket.getOnPadYOffset(), rocket.posZ - 0.5);
