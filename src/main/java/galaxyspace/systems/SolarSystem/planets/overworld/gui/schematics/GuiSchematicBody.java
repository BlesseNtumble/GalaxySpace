...
public class GuiSchematicBody extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicBody(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicBody(par1InventoryPlayer, x, y, z));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.RocketBody.name"), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        final int var6 = (this.height - this.ySize) / 2;      
	       ...
	       this.drawTexturedModalRect(var5 + 126, var6 + 40, 49, 0, 48, 68);        
