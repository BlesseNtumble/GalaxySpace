...
public class GuiSchematicBody extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicBody(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        super(new ContainerSchematicBody(par1InventoryPlayer, pos));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.rocket_body.name"), 7, -20 + 27, 4210752);
