...
public class GuiRecycler extends GuiContainerGC
{
    ...
    public GuiRecycler(InventoryPlayer par1InventoryPlayer, TileEntityRecycler tileEntity)
    {
        super(new ContainerRecycler(par1InventoryPlayer, tileEntity));
    ...
    {
        this.mc.renderEngine.bindTexture(GuiRecycler.guiTexture);
        ...
        if (this.tileEntity.processTicks > 0)
        {
            ...
            this.drawTexturedModalRect(containerWidth + 84, containerHeight + 44, 192 + 20, 124, 16 - scale, 17);
