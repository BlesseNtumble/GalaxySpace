...
public class GuiAssemblyMachine extends GuiContainerGC
{
    ...
    public GuiAssemblyMachine(InventoryPlayer par1InventoryPlayer, TileEntityAssemblyMachine tileEntity)
    {
        super(new ContainerAssemblyMachine(par1InventoryPlayer, tileEntity));
    ...
    {
        this.fontRendererObj.drawString(EnumColor.WHITE + this.tileEntity.getInventoryName(), 13, 5, 4210752);
        String displayText;
        ...
        this.fontRendererObj.drawString(str, 135 - this.fontRendererObj.getStringWidth(str) / 2, 95, 4210752);
        this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("container.inventory"), 15, this.ySize - 91, 4210752);
...
//		this.fontRendererObj.drawString(str, 120 - this.fontRendererObj.getStringWidth(str) / 2, 95, 4210752);
    ...
    {
        this.mc.renderEngine.bindTexture(GuiAssemblyMachine.electricFurnaceTexture);
        ...
        {
            this.drawTexturedModalRect(containerWidth + 91, containerHeight + 31, 176, 0, 17, 13);
        }        
    }
}
