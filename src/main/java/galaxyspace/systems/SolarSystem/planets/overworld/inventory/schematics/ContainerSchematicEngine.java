...
public class ContainerSchematicEngine extends Container
{
    ...
    public ContainerSchematicEngine(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        {        	    
       		this.addSlotToContainer(new SlotSchematicEngine(this.craftMatrix, var6 + 1, 6 + var6 * 19, 21 + change, x, y, z, par1InventoryPlayer.player));
        }
        ...
        for (var6 = 0; var6 < 2; ++var6)
        {
        	for (var7 = 0; var7 < 3; ++var7)            
       		this.addSlotToContainer(new SlotSchematicEngine(this.craftMatrix, var6 + var7 * 2 + 6, 25 + var7 * 19, 40 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
        
        for (var6 = 0; var6 < 5; ++var6)
        {        	    
       		this.addSlotToContainer(new SlotSchematicEngine(this.craftMatrix, var6 + 12, 6 + var6 * 19, 78 + change, x, y, z, par1InventoryPlayer.player));
        }
        
        this.addSlotToContainer(new SlotSchematicEngine(this.craftMatrix, 17, 25, 97 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(new SlotSchematicEngine(this.craftMatrix, 18, 63, 97 + change, x, y, z, par1InventoryPlayer.player));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (var2.getItem() == GSItems.HeavyDutyPlates || var2.getItem() == MarsItems.marsItemBasic && var2.getItemDamage() == 3 || var2.getItem() == AsteroidsItems.basicItem && var2.getItemDamage() == 0)
            {
            ...
            else if (var2.getItem() == Item.getItemFromBlock(MarsBlocks.hydrogenPipe))
            {
            ...
            else if (var2.getItem() == GSItems.RocketParts)
            {
