...
public class EntityTier4Rocket extends EntityTieredRocket
{
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            stats.rocketItem = GSItems.Tier4Rocket;
    ...
    protected void spawnParticles(boolean launched)
    {
        if (!this.isDead)
        {
            ...
            Vector3 d1 = new Vector3(y1 * 0.1D, -x1 * 0.1D, z1 * 0.1D).rotate(270 - this.rotationYaw, motionVec);
            Vector3 d2 = new Vector3(x1 * 0.1D, -z1 * 0.1D, y1 * 0.1D).rotate(315 - this.rotationYaw, motionVec);
            Vector3 d3 = new Vector3(-y1 * 0.1D, x1 * 0.1D, z1 * 0.1D).rotate(270 - this.rotationYaw, motionVec);
    ...
    {    	
    	return GSUtils.fillWithGCFuel(this.fuelTank, liquid, doFill);
    }
    ...
    */
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
    {
        ...
        ItemStack rocket = new ItemStack(GSItems.Tier4Rocket, 1, this.rocketType.getIndex());
