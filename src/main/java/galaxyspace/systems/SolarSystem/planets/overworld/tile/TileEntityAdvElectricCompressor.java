...
public class TileEntityAdvElectricCompressor extends TileBaseElectricBlock implements ISidedInventory
{
    ...
    public TileEntityAdvElectricCompressor()
    {
    	super("tile.adv_electric_compressor.name");
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.hasEnoughEnergyToRun)
            {
                if (this.canCompress())
                {
                    ...
                    this.processTicks += 3 + boost_speed;
    ...
    {
        return this.getInventory().size() + this.compressingCraftMatrix.getSizeInventory();
    }
    ...
    public EnumFacing getFront()
    {
        ...
        if (state.getBlock() instanceof BlockAdvElectricCompressor)
        {
            return state.getValue(BlockAdvElectricCompressor.FACING);
        }
