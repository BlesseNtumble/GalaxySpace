...
public class TileEntityAdvElectricCompressor extends TileBaseElectricBlock implements IInventoryDefaults, ISidedInventory
{
    ...
    {
        return GCCoreUtil.translate("tile.adv_electric_compressor.name");
    }
