...
public class ContainerModernStorageModule extends Container
{
    private TileEntityModernStorageModule tileEntity;

    public ContainerModernStorageModule(InventoryPlayer par1InventoryPlayer, TileEntityModernStorageModule batteryBox)
    {
