...
public class ContainerSchematicBody extends Container
{
    ...
    public ContainerSchematicBody(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        for (var6 = 0; var6 < 6; ++var6)
        {
        	for (var7 = 0; var7 < 4; ++var7)            
       		this.addSlotToContainer(new SlotSchematicBody(this.craftMatrix, var6 + var7 * 6 + 1, 16 + var7 * 19, 10 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
    ...
    {
        this.craftResult.setInventorySlotContents(0, GSRecipeUtil.findMatchingBodyRecipe(this.craftMatrix));
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (var2.getItem() == GSItems.RocketModules && var2.getItemDamage() == 3)
            {
