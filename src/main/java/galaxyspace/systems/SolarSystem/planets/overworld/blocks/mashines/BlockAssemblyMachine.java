...
public class BlockAssemblyMachine extends BlockTileGC implements IBlockShiftDesc
{
    ...
    public BlockAssemblyMachine()
    {
        ...
        this.setBlockName("AssemblyMachine");
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        this.iconCompressor = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/assembly_machine");
    }
