...
public class ItemTier6Rocket extends Item implements IHoldableItem
{
    public ItemTier6Rocket()
    {
        super();
        this.setMaxDamage(0);
        this.setHasSubtypes(true);
        this.setMaxStackSize(1);
        this.setUnlocalizedName("Tier6Rocket");
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (padFound)
            {
                ...
                {
                    rocket.fuelTank.fill(new FluidStack(GSFluids.HeliumHydrogen, par1ItemStack.getTagCompound().getInteger("RocketFuel")), true);
                }
                ...
                {
                    rocket.fuelTank.fill(new FluidStack(GSFluids.HeliumHydrogen, rocket.getMaxFuel()), true);
                }
            }
            else
            {
