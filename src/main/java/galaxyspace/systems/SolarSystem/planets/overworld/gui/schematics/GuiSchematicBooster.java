...
public class GuiSchematicBooster extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicBooster(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        super(new ContainerSchematicBooster(par1InventoryPlayer, pos));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + GCCoreUtil.translate("item.rocket_booster.name"), 7, -20 + 27, 4210752);
