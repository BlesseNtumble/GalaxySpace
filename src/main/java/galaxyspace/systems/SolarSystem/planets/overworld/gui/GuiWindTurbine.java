...
public class GuiWindTurbine
extends GuiContainerGC {
    private static final ResourceLocation solarGuiTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/gui/windturbine.png");
    private final TileEntityWindTurbine solarPanel;
    private GuiButton buttonEnableSolar;
    private GuiElementInfoRegion electricInfoRegion;

    public GuiWindTurbine(InventoryPlayer par1InventoryPlayer, TileEntityWindTurbine solarPanel) {
        super((Container)new ContainerWindTurbine(par1InventoryPlayer, solarPanel));
    ...
    public void initGui() {
        ...
        sunGenDesc.add(this.solarPanel.getWindBoost() > 0.0f ? GCCoreUtil.translate((String)"gui.status.wind.name") : GCCoreUtil.translate((String)"gui.status.nowind.name"));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        displayString = GCCoreUtil.translate((String)"gui.message.generating.name") + ": " + (this.solarPanel.generateWatts > 0.0f ? EnergyDisplayHelper.getEnergyDisplayS((float)this.solarPanel.generateWatts) + "/t" : GCCoreUtil.translate((String)"gui.status.notGenerating.name"));
        ...
        float boost = (float)Math.round((this.solarPanel.getWindBoost() - 1.0f) * 1000.0f) / 10.0f;
