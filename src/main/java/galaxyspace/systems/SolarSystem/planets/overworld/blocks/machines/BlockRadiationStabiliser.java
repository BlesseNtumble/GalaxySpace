...
public class BlockRadiationStabiliser extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public BlockRadiationStabiliser()
    {
        ...
        this.setUnlocalizedName("radiation_stabiliser");
