...
{
	public final static int tankCapacity = 10000;
    ...
    {
        return side != this.getBlockMetadata() + 2 ? new int[] { 0, } : new int[] { };
    }
...
*/
    ...
    public RemovalResult removeCargo(boolean doRemove)
    {
    	if(this.waterTank.getFluidAmount() > 0)
    	{
            ...
            {
    			this.markDirty();
    			return new RemovalResult(EnumCargoLoadingState.SUCCESS, null);               
            }
    	}
    	/*
