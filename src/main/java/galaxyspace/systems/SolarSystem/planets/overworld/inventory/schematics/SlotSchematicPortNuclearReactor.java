...
public class SlotSchematicPortNuclearReactor extends Slot
{
    private final int index;
    private final int x, y, z;
    private final EntityPlayer player;

    public SlotSchematicPortNuclearReactor(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z, EntityPlayer player)
    {
    ...
    public boolean isItemValid(ItemStack par1ItemStack)
    {
        switch (this.index)
        {
	        ...
	        case 23: 
	        case 24: 
	        	return par1ItemStack.getItem() == MarsItems.marsItemBasic && par1ItemStack.getItemDamage() == 1;

	        case 6: 
	        case 10:
	        case 16:
	        case 20:
	        	return par1ItemStack.getItem() == AsteroidsItems.basicItem && par1ItemStack.getItemDamage() == 6;
	        ...
	        case 18:
	        case 19:
	        	return par1ItemStack.getItem() == GSItems.HeavyDutyPlates && par1ItemStack.getItemDamage() == 1;


        	case 11: return par1ItemStack.getItem() == Item.getItemFromBlock(GSBlocks.FluidTank);
        	
        	case 12: 
        	case 14:
        		return par1ItemStack.getItem() == AsteroidsItems.basicItem && par1ItemStack.getItemDamage() == 8;
        
        	case 13: return par1ItemStack.getItem() == GSItems.BasicItems && par1ItemStack.getItemDamage() == 0;

        	case 15: return par1ItemStack.getItem() == Item.getItemFromBlock(GSBlocks.FuelGenerator);
