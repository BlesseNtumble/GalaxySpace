...
public class SchematicBody implements ISchematicPage
{
    @Override
    ...
    {
        return new GuiSchematicBody(player.inventory, x, y, z);
    }

    @Override
    public Container getResultContainer(EntityPlayer player, int x, int y, int z)
    {
        return new ContainerSchematicBody(player.inventory, x, y, z);
    }
