...
public class GuiSchematicOxTank extends GuiContainerGC implements ISchematicResultPage
{
    ...
    public GuiSchematicOxTank(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        super(new ContainerSchematicOxTank(par1InventoryPlayer, pos));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRenderer.drawString(EnumColor.WHITE + GSItems.OXYGENTANK_TIER_EPP.getItemStackDisplayName(new ItemStack(GSItems.OXYGENTANK_TIER_EPP, 1, 0)), 7, -20 + 27, 4210752);
