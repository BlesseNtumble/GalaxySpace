...
public class GuiSchematicOxTank extends GuiContainerGC implements ISchematicResultPage
{
    ...
    private static final ResourceLocation TankTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/gui/schematics/schematic_parts.png");

    private int pageIndex;

    public GuiSchematicOxTank(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new ContainerSchematicOxTank(par1InventoryPlayer, x, y, z));
        this.xSize = 191;
        this.ySize = 250;
    }
    ...
    {
    	this.fontRendererObj.drawString(EnumColor.WHITE + GSItems.OxygenTankEPPTier1.getItemStackDisplayName(new ItemStack(GSItems.OxygenTankEPPTier1, 1, 0)), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
	    ...
	    this.mc.renderEngine.bindTexture(this.TankTexture);
	    this.drawTexturedModalRect(var5 + 130, var6 + 37, 0, 58, 52, 64);               
     }
