...
public class TileEntityOxygenFiller extends TileEntityOxygen implements IInventory, ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
            	for(int i = 1; i <= 3; i++) {
                ItemStack tank0 = this.containingItems[i];

	                if (tank0 != null)
	                {
	                    if (tank0.getItem() instanceof ItemOxygenCanisterBase && tank0.getItemDamage() > 0)
	                    {
	                    	
	                        tank0.setItemDamage(tank0.getItemDamage() - 1);
	                        this.storedOxygen -= ((ItemOxygenCanisterBase)tank0.getItem()).recharge(tank0);
	                        this.usingEnergy = true;
	                    }
	                    
	                    else if (tank0.getItem() instanceof ItemOxygenTank && tank0.getItemDamage() > 0)
	                    {
    ...
    {
        return GCCoreUtil.translate("tile.OxygenFiller.name");
    }
    ...
    public boolean canExtractItem(int slotID, ItemStack itemstack, int side)
    {
        ...
        case 2:
        case 3:
    		return itemstack.getItem() instanceof ItemOxygenTank && itemstack.getItemDamage() == 0 || itemstack.getItem() instanceof IItemOxygenSupply && itemstack.getItemDamage() == 0 || FluidUtil.isEmptyContainer(itemstack);    
    	default:
    		return false;
    	}
    }
