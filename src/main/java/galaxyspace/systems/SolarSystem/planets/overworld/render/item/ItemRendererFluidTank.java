...
public class ItemRendererFluidTank implements IItemRenderer{
	
	private static final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(GalaxySpace.ASSET_PREFIX, "models/tank.obj") ); 
