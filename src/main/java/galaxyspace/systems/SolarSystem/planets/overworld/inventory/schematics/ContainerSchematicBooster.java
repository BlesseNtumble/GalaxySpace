...
public class ContainerSchematicBooster extends Container
{
    ...
    public ContainerSchematicBooster(InventoryPlayer par1InventoryPlayer, BlockPos pos)
    {
        final int change = 27;
        ...
        this.addSlotToContainer(new SlotSchematicBooster(this.craftMatrix, 1, 44, 27 + change, pos, par1InventoryPlayer.player));
        
        // Body Center
        for (var6 = 0; var6 < 3; ++var6)
        {
        	for (var7 = 0; var7 < 3; ++var7)            
       		this.addSlotToContainer(new SlotSchematicBooster(this.craftMatrix, var6 + var7 * 3 + 2, 25 + var7 * 19, 46 + var6 * 19 + change, pos, par1InventoryPlayer.player));
        }
    ...
    {
    	this.craftResult.setInventorySlotContents(0, GSUtils.findMatchingNASARecipe(GSRecipeUtil.getBoosterRecipes(), this.craftMatrix));
    }
