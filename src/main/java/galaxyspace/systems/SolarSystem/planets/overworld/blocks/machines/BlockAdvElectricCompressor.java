...
public class BlockAdvElectricCompressor extends BlockAdvancedTile implements IShiftDescription, ISortableBlock{

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    
	public BlockAdvElectricCompressor()
    {
        super(GCBlocks.machine);
        this.setUnlocalizedName("adv_electric_compressor");
    ...
    {
        return new TileEntityAdvElectricCompressor();
    }
