...
public class ContainerAdvElectricCompressor extends Container
{
    private TileEntityAdvElectricCompressor tileEntity;

    public ContainerAdvElectricCompressor(InventoryPlayer par1InventoryPlayer, TileEntityAdvElectricCompressor tileEntity)
    {
        ...
        // Smelting result
        this.addSlotToContainer(new SlotFurnaceOutput(par1InventoryPlayer.player, tileEntity, 1, 145, 24));
        this.addSlotToContainer(new SlotFurnaceOutput(par1InventoryPlayer.player, tileEntity, 2, 145, 49));
