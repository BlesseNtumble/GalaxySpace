...
public class ContainerOxygenStorageModule extends Container
{
    ...
    public ContainerOxygenStorageModule(InventoryPlayer par1InventoryPlayer, TileEntityAdvOxygenStorageModule storageModule)
    {
        ...
        for (var3 = 0; var3 < 3; ++var3)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par1InventoryPlayer, var4 + var3 * 9 + 9, 8 + var4 * 18, 97 + var3 * 18));
            }
        }

        for (var3 = 0; var3 < 9; ++var3)
        {
            this.addSlotToContainer(new Slot(par1InventoryPlayer, var3, 8 + var3 * 18, 155));
        }
