...
public class BlockSolarWindPanel extends BlockTileGC implements IBlockShiftDesc, IPartialSealableBlock
{
    ...
    public BlockSolarWindPanel()
    {
        ...
        //this.setBlockTextureName(GalaxySpace.ASSET_PREFIX + ":" + "solarwind");
        this.setBlockName("SolarWindPanel");
    }
    ...
    {
        par3List.add(new ItemStack(par1, 1, BlockSolarWindPanel.BASIC_METADATA));
    }

    @Override
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        this.icons[0] = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/solarwind_basic_0");
    ...
    {
    	if (meta >= BlockSolarWindPanel.BASIC_METADATA)
        {
            int shiftedMeta = meta -= BlockSolarWindPanel.BASIC_METADATA;
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
        ...
        case 3:
            ...
            world.setBlockMetadataWithNotify(x, y, z, BlockSolarWindPanel.BASIC_METADATA + change, 3);
        ...
        {
            ((TileEntitySolarWind) tile).onCreate(new BlockVec3(x, y, z));
        }
    }
    ...
    public void breakBlock(World var1, int var2, int var3, int var4, Block var5, int var6)
    {
        ...
        if (var9 instanceof TileEntitySolarWind)
        {
            ((TileEntitySolarWind) var9).onDestroy(var9);
        }
    ...
    public int damageDropped(int metadata)
    {
            ...
            return BlockSolarWindPanel.BASIC_METADATA;
    ...
    public TileEntity createTileEntity(World world, int metadata)
    {
            ...
            return new TileEntitySolarWind(1);
	...
	public String getDescription(int meta) {
		return GCCoreUtil.translate("tile.coefficient.desc") + ": x" + GSConfigEnergy.coefficientSolarWindPanel;
	}
    ...
    public String getShiftDescription(int meta)
    {
        ...
        {
        case BASIC_METADATA:
            return GCCoreUtil.translate("tile.SolarWindPanel.desc");
        }
        return "";
    }
