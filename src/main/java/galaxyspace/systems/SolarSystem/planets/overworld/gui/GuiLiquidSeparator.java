...
//		this.fontRendererObj.drawString(str, 120 - this.fontRendererObj.getStringWidth(str) / 2, 95, 4210752);
    ...
    {    	
        ...
        {
	        GL11.glPushMatrix();	        
	        GSUtils.drawFluid(fluid, this.width / 2 - 8, this.height / 2 - 62, 16, 38, this.tileEntity.baseTank.getCapacity());
			GL11.glPopMatrix();
        }
        ...
        {
        	GL11.glPushMatrix();	        
	        GSUtils.drawFluid(fluid1, this.width / 2 + 57, this.height / 2 - 62, 16, 38, this.tileEntity.waterTank1.getCapacity());
			GL11.glPopMatrix();
        }
        ...
        {
        	GL11.glPushMatrix();	        
	        GSUtils.drawFluid(fluid2, this.width / 2 - 78, this.height / 2 - 62, 16, 38, this.tileEntity.waterTank2.getCapacity());
			GL11.glPopMatrix();
        }
    ...
    protected void actionPerformed(GuiButton btn)
    {
        ...
        case BTN_REVERSE:
            ...
            GalaxySpace.packetPipeline.sendToServer(new GSPacketSimple(GSEnumSimplePacket.S_REVERSE_SEPATATOR, new Object[] { new BlockVec3(this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord) }));
            break;
        }
    }
