...
public class ContainerSchematicTier2Rocket extends Container {
    ...
    public ContainerSchematicTier2Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        ...
        // Cone
        this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 1, 48 + xOffset, change, x, y, z, par1InventoryPlayer.player));

        // Body
        for (var6 = 0; var6 < 5; ++var6)
        {
            this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 2 + var6, 39 + xOffset, -6 + var6 * 18 + 25 + change, x, y, z, par1InventoryPlayer.player));
        }

        // Body Right
        for (var6 = 0; var6 < 5; ++var6)
        {
            this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 7 + var6, 57 + xOffset, -6 + var6 * 18 + 25 + change, x, y, z, par1InventoryPlayer.player));
        }
        ...
        // Engine
        this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 15, 48 + xOffset, 110 + change, x, y, z, par1InventoryPlayer.player));
        ...
        {
            this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 19 + var8, 113 + var8 * 24, 11 + change, x, y, z, par1InventoryPlayer.player));
        }
        
        // Addons GS
        for (int var8 = 0; var8 < 3; var8++)
        {
            this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 22 + var8, 80, 9 + var8 * 21 + change, x, y, z, par1InventoryPlayer.player));
        }
        
        this.addSlotToContainer(new SlotSchematicTier2Rocket(this.craftMatrix, 25, 145, 44 + change, x, y, z, par1InventoryPlayer.player));
