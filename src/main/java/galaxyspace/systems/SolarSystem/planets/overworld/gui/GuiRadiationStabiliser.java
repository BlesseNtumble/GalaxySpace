...
public class GuiRadiationStabiliser extends GuiContainerGC implements ICheckBoxCallback{
    ...
    public void initGui()
    {
        ...
        desc.add(GCCoreUtil.translate("gui.batterySlot.desc.0"));
        desc.add(GCCoreUtil.translate("gui.batterySlot.desc.1"));
        ...
        desc.add(GCCoreUtil.translate("gui.showBubble.desc.0"));
        ...
        this.checkboxRenderBubble = new GuiElementCheckbox(0, this, var5 + 10, var6 + 67, EnumColor.WHITE + GCCoreUtil.translate("gui.message.bubbleVisible.name"));
    ...
    {
        String displayString = EnumColor.WHITE + tileEntity.getInventoryName();
        this.fontRendererObj.drawString(displayString, this.xSize / 2 - this.fontRendererObj.getStringWidth(displayString) / 2, 1, 4210752);
        this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("container.inventory"), 16, 116, 4210752);
        this.fontRendererObj.drawSplitString(EnumColor.WHITE + GCCoreUtil.translate("gui.message.status.name") + ": " + this.getStatus(), 105, 104, this.xSize - 105, 4210752);
    }
    ...
    public void onSelectionChanged(GuiElementCheckbox checkbox, boolean newSelected)
    {
        ...
        GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, new Object[] { 6, this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord, newSelected ? 1 : 0 }));
    }
