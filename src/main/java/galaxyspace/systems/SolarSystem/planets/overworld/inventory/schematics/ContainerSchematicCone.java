...
public class ContainerSchematicCone extends Container
{
    ...
    public ContainerSchematicCone(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        // Cone
        this.addSlotToContainer(new SlotSchematicCone(this.craftMatrix, 1, 44, 13 + change, x, y, z, par1InventoryPlayer.player));
        
        for (var6 = 0; var6 < 3; ++var6)
        {
       		this.addSlotToContainer(new SlotSchematicCone(this.craftMatrix, 2 + var6, 22 + var6 * 19 + 3, 32 + change, x, y, z, par1InventoryPlayer.player));
        }
        ...
        for (var6 = 0; var6 < 4; ++var6)
        {
        	for (var7 = 0; var7 < 5; ++var7)            
       		this.addSlotToContainer(new SlotSchematicCone(this.craftMatrix, var6 + var7 * 4 + 5, 6 + var7 * 19, 51 + var6 * 19 + change, x, y, z, par1InventoryPlayer.player));
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (var2.getItem() == Item.getItemFromBlock(GSBlocks.FutureGlass))
            {
            ...
            else if (var2.getItem() == GSItems.RocketModules)
            {
