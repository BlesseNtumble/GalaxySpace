...
public class TileEntityOxStorageModule extends TileEntityOxygen implements IPacketReceiver, ISidedInventory, IFluidHandler
{
    ...
    public static final int OXYGEN_CAPACITY = 60000 * 2;
    ...
    public void updateEntity()
    {
        ...
        this.produceOxygen(ForgeDirection.getOrientation((this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2) ^ 1));
    ...
    {
        return this.getOxygenOutputDirection() == direction ? Math.min(TileEntityOxStorageModule.OUTPUT_PER_TICK, this.getOxygenStored()) : 0.0F;
    }

    @Override
    public EnumSet<ForgeDirection> getOxygenInputDirections()
    {
        return EnumSet.of(ForgeDirection.getOrientation(this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2));
    }

    @Override
    public EnumSet<ForgeDirection> getOxygenOutputDirections()
    {
        return EnumSet.of(ForgeDirection.getOrientation((this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2) ^ 1));
    }
    
    public ForgeDirection getOxygenOutputDirection()
    {
        return ForgeDirection.getOrientation((this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2) ^ 1);
    }
    ...
    {
        return GCCoreUtil.translate("tile.OxygenStorageModuleT2_4.name");
    }
    ...
    {
        if (from.ordinal() == this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2 && GalacticraftCore.isPlanetsLoaded)
        {
    ...
    public FluidTankInfo[] getTankInfo(ForgeDirection from)
    {
        ...
        int metaside = this.getBlockMetadata() - BlockOxStorageModuleT2.OxSTORAGE_MODULE_T2 + 2;
