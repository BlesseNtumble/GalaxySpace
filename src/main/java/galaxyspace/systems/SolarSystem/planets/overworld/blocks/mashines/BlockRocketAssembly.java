...
public class BlockRocketAssembly extends BlockTileGC implements IBlockShiftDesc
{
    private IIcon iconMachineSide;
    private IIcon iconInput;
    private IIcon iconCompressor;

    public BlockRocketAssembly()
    {
        super(GCBlocks.machine);
        this.setBlockName("RocketAssembly");
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        this.iconCompressor = iconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "overworld/rocketassembly");
    }
    ...
    {
        return new TileEntityRocketAssemblyMachine();
	...
	public String getDescription(int meta) {
		return GCCoreUtil.translate("tile.coefficientcraft.desc") + ": x" + GSConfigEnergy.coefficientSpeedRocketAssembly;
	}
	
    @Override
    public String getShiftDescription(int meta)
    {
    	return GCCoreUtil.translate("tile.RocketAssembly.desc");
    }
