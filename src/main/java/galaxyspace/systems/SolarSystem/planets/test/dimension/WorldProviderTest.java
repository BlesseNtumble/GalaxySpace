...
public class WorldProviderTest extends WorldProviderAdvancedSpace implements IGalacticraftWorldProvider, IExitHeight, ISolarLevel{
		
	@Override
	public CelestialBody getCelestialBody() {
	    return SolarSystemBodies.testPlanet;
	}
	 
	@Override
    public float getGravity() {
        return BodiesHelper.calculateGravity(10.0F);
    }
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return ChunkProviderTest.class;
    } 
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerTest.class;
    }
