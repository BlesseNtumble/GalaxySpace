...
public class RoomSpawnerCeres extends RoomEmptyCeres
{
    public RoomSpawnerCeres()
    {
    }

    public RoomSpawnerCeres(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, EnumFacing entranceDir)
	{
		this(configuration, rand, blockPosX, blockPosZ, rand.nextInt(4) + 8, configuration.getRoomHeight(), rand.nextInt(4) + 8, entranceDir);
	}
    
    public RoomSpawnerCeres(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, int sizeX, int sizeY, int sizeZ, EnumFacing entranceDir)
    {
