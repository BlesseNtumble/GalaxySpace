...
public class EntityBossBlaze extends EntityMob implements IEntityBreathable, IBossDisplayData, IRangedAttackMob, IBoss
{
    ...
    private boolean spawnedMinion = false;
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote)
        {
            ...
            {
                if (tile instanceof TileEntityCeresTreasureChest)
                {
                    ...
                    TileEntityCeresTreasureChest chest = (TileEntityCeresTreasureChest) tile; 
            ...
            this.entityDropItem(new ItemStack(GSItems.TierKeys, 1, 0), 0.5F);
    ...
    public void onLivingUpdate()
    {
        ...
        else if (this.getHealth() <= this.getMaxHealth() / 2.0 && !spawnedMinion)
        {
        	this.spawnedMinion = true;
        	if(!worldObj.isRemote) {	        	
	        	for(int i = 0; i < 4; i++)
	        	{
	        		Entity entity = new EntityEvolvedColdBlaze(worldObj);
	        		entity.setPosition(this.posX + this.worldObj.rand.nextFloat(), this.posY, this.posZ + this.worldObj.rand.nextFloat());
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6)
    {
        ...
        double d7 = par4 - d4;
        double d8 = par6 - d5;
        EntitySmallFireball entityfireball = new EntitySmallFireball(this.worldObj, this, d6 * 0.5D, d7 * 0.5D, d8 * 0.5D);
