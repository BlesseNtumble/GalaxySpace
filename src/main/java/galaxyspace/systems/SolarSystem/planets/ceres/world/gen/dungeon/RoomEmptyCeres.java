...
public class RoomEmptyCeres extends GSDungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;

    public RoomEmptyCeres(GSMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomEmptyCeres(dungeon, x, y, z, dir);
    }
