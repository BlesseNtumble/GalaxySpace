package galaxyspace.systems.SolarSystem.planets.ceres.render.tile;
...
public class TileEntityCeresTreasureChestRenderer extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX + ":" + "textures/model/ceresTreasureChest.png");
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX + ":" + "textures/model/ceresLargeTreasureChest.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityCeresTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				((CeresBlockT4TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
			{
				...
				this.bindTexture(TileEntityCeresTreasureChestRenderer.treasureChestTexture);
			}
			else
			{
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityCeresTreasureChestRenderer.treasureLargeChestTexture);
			}
	...
	{
		this.renderGCTileEntityTreasureChestAt((TileEntityCeresTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}