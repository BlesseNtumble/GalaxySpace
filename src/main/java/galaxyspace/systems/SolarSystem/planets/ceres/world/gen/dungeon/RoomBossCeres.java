...
public class RoomBossCeres extends GSDungeonRoom
{
    public int sizeX;
    public int sizeY;
    public int sizeZ;
    ...
    public void generate(Block[] chunk, byte[] meta, int cx, int cz)
    {
        ...
        for(int i = -n; i < n; i++)
        {
        	for(int j = -n; j < n; j++)
            {
        		this.placeBlock(chunk, meta, hx, this.posY - 1, hz + j, cx, cz, block, 0);
        		this.placeBlock(chunk, meta, hx + i, this.posY - 1, hz, cx, cz, block, 0);
        		this.placeBlock(chunk, meta, hx + i, this.posY - 2, hz + j, cx, cz, Blocks.packed_ice, 0);
    ...
    protected void handleTileEntities(Random rand)
    {
        ...
        {
            TileEntityDungeonSpawner spawner = new TileEntityDungeonSpawnerCeres();
