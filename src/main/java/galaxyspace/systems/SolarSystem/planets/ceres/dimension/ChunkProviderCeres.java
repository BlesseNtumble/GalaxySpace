...
import galaxyspace.systems.SolarSystem.planets.ceres.world.gen.dungeon.RoomChestsCeres;
...
public class ChunkProviderCeres extends ChunkProviderSpaceLakes {
	...
	private final GSMapGenDungeon dungeonGenerator = new GSMapGenDungeon(GSBlocks.DungeonBricks, 0, 8, 16, 3, GSBlocks.CeresBlocks, 5, GSBlocks.CeresBlocks, 4);
