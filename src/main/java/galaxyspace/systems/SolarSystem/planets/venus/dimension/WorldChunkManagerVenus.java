...
public class WorldChunkManagerVenus extends WorldChunkManagerSpace {
	...
	public WorldChunkManagerVenus()
	{
		...
		this.biomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains);
		this.biomesToSpawnIn.add(GSBiomeGenBase.GSSpaceShallowWaters);
	}
    ...
    public BiomeGenBase getBiome() {
        ...
        return GSBiomeGenBase.GSSpaceLowHills;
