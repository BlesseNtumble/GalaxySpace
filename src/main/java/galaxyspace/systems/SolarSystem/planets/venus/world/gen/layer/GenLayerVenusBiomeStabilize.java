package galaxyspace.systems.SolarSystem.planets.venus.world.gen.layer;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.IntCache;

public class GenLayerVenusBiomeStabilize extends GenLayer
{
	public GenLayerVenusBiomeStabilize(long seed, GenLayer genlayer)
	{
		super(seed);
