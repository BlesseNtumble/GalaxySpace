...
public class RenderEvolvedFireCreeper extends RenderCreeper
{
    private static final ResourceLocation creeperfireTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/creeperfire.png");
    ...
    public RenderEvolvedFireCreeper()
    {
        super();
    ...
    {
        return RenderEvolvedFireCreeper.creeperfireTexture;
    }
    ...
    {
        EntityEvolvedFireCreeper creeper = (EntityEvolvedFireCreeper) par1EntityLiving;
        ...
        if (helmetSlot != null && helmetSlot.getItem() instanceof ItemSensorGlasses && minecraft.currentScreen == null)
        {
            if (par2 == 1)
            {
                ...
                this.bindTexture(RenderEvolvedFireCreeper.powerTexture);
