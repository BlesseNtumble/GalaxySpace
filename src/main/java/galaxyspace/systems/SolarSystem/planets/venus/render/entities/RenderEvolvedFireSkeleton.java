...
public class RenderEvolvedFireSkeleton extends RenderBiped
{
    private static final ResourceLocation skeletonTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/skeletonfire.png");
    ...
    public RenderEvolvedFireSkeleton()
    {
        ...
        try
        {
            ...
            RenderEvolvedFireSkeleton.isBG2Loaded = clazz.getField("Skell_Arrow_Datawatcher").getInt(null);
        }
        catch (Exception e)
        {
        }
    ...
    {
        return RenderEvolvedFireSkeleton.skeletonTexture;
    }
    ...
    protected int shouldRenderPass(EntityLivingBase par1EntityLiving, int par2, float par3)
    {
        ...
        if (helmetSlot != null && helmetSlot.getItem() instanceof ItemSensorGlasses && minecraft.currentScreen == null)
        {
            if (par2 == 1)
            {
                ...
                this.bindTexture(RenderEvolvedFireSkeleton.powerTexture);
