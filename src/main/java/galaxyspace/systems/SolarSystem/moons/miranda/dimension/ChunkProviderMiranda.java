...
import galaxyspace.systems.SolarSystem.moons.miranda.world.gen.MapGenCavesMiranda;
...
public class ChunkProviderMiranda
extends ChunkProviderSpaceLakes {
    ...
    protected BlockMetaPair getGrassBlock() {
        return new BlockMetaPair(GSBlocks.MirandaBlocks, (byte) 0);
    }

    @Override
    protected BlockMetaPair getDirtBlock() {
        return new BlockMetaPair(GSBlocks.MirandaBlocks, (byte) 1);
    }

    @Override
    protected BlockMetaPair getStoneBlock() {
        return new BlockMetaPair(GSBlocks.MirandaBlocks, (byte) 2);
    }
