...
public class MapGenCavernGanymede  extends MapGenBaseMeta
{
    @Override
                                ...
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            ...
                                            if (arrayOfIDs[coords] == GSBlocks.GanymedeBlocks && arrayOfMeta[coords] != 0)
                                            {
                                                arrayOfIDs[coords] = Blocks.water;
                                            }
                                        }
                                    }
                                }
