...
import galaxyspace.systems.SolarSystem.moons.ganymede.world.gen.layer.GenLayerGanymede;
...
public class WorldChunkManagerGanymede extends WorldChunkManagerSpace {
	...
	protected WorldChunkManagerGanymede()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList();
		this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace);
		//this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains);

	}

	public WorldChunkManagerGanymede(long seed)
	{
		this();
		GenLayer[] agenlayer;
		agenlayer = GenLayerGanymede.makeTheWorld(seed);
		this.unzoomedBiomes = agenlayer[0];
		this.zoomedBiomes = agenlayer[1];
	}

	public WorldChunkManagerGanymede(World world)
	{
		this(world.getSeed());
	}
