...
import galaxyspace.systems.SolarSystem.moons.ganymede.dimension.sky.SkyProviderGanymede;
...
public class WorldProviderGanymede extends WorldProviderAdvancedSpace implements IProviderFreeze, IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace{
    ...
    public CelestialBody getCelestialBody() {
        ...
        return SolarSystemBodies.ganymedeJupiter;
    ...
    public float getSunBrightness(float par1) {
       ...
       f2 = 1.2F - f2;
       if(f3 > getDayLength() / 2 * 0.37 && f3 < getDayLength() / 2 * 0.63)
       {
    	   return f2 * 0.1F;
       }
       return f2 * 1.0F;
	...
	public IRenderHandler getSkyRenderer()
	{
		...
		{
			this.setSkyRenderer(new SkyProviderGanymede());
		}
