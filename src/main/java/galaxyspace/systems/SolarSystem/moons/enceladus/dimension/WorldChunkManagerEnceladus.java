...
public class WorldChunkManagerEnceladus extends WorldChunkManagerSpace {
	/*
	...
	protected WorldChunkManagerEnceladus()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList();
		this.myBiomesToSpawnIn.add(BiomeGenBaseEnceladus.Enceladus);
		//this.myBiomesToSpawnIn.add(BiomeGenBaseEnceladus.EnceladusWater);
	}

	public WorldChunkManagerEnceladus(long seed)
	{
		this();
		GenLayer[] agenlayer;
		agenlayer = GenLayerEnceladus.makeTheWorld(seed);
		this.unzoomedBiomes = agenlayer[0];
		this.zoomedBiomes = agenlayer[1];
	}

	public WorldChunkManagerEnceladus(World world)
	{
		this(world.getSeed());
	}
