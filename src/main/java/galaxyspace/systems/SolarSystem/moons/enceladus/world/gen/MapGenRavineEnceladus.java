...
public class MapGenRavineEnceladus extends MapGenBaseMeta
{
	...
	@Override
	protected void recursiveGenerate(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_, byte[] metaArray)
	{
	...
	protected void digBlock(Block[] data, int index, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop)
	{
		...
		if (block == Blocks.packed_ice || block == GSBlocks.EnceladusBlocks || block == filler || block == top)
		{
			...
			if(data[index - 1] == GSBlocks.EnceladusBlocks)
			{
				data[index - 1] = Blocks.packed_ice;
			}
