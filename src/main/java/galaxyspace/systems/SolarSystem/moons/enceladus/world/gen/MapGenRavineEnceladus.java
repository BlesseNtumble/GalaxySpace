...
public class MapGenRavineEnceladus extends MapGenBaseMeta
{
	...
	protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
		...
		if (state.getBlock() == GSBlocks.ENCELADUS_BLOCKS || state.getBlock() == Blocks.PACKED_ICE 
			...
			if(data.getBlockState(x, y - 1, z).getBlock() == GSBlocks.ENCELADUS_BLOCKS)				
			{
				data.setBlockState(x, y - 1, z, Blocks.PACKED_ICE.getDefaultState());
			}
			//}
		}
	}
