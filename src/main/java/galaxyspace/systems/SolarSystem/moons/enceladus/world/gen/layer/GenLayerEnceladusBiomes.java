package galaxyspace.systems.SolarSystem.moons.enceladus.world.gen.layer;
...
public class GenLayerEnceladusBiomes extends GenLayer
{
	protected BiomeGenBase[] commonBiomes = { GSBiomeGenBase.GSSpace};
	protected BiomeGenBase[] rareBiomes = { GSBiomeGenBase.GSSpace };

	public GenLayerEnceladusBiomes(long seed, GenLayer genlayer)
	{
		super(seed);
		this.parent = genlayer;
	}

	public GenLayerEnceladusBiomes(long seed)
	{
		super(seed);
	}
