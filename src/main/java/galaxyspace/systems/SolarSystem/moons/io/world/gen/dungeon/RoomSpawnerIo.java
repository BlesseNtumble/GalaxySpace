...
public class RoomSpawnerIo extends GSDungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomSpawnerIo(GSMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
            ...
            for (int j = this.posY - 1; j <= this.posY + this.sizeY; j++)
            {
                for (int k = this.posZ - 1; k <= this.posZ + this.sizeZ; k++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.placeBlock(chunk, meta, i, j, k, cx, cz, GSBlocks.CeresWeb, 0);
                        }
                    }
                }
            }
    ...
    private static String getMob(Random rand)
    {
        ...
        {
        case 0:
            return "GalaxySpace.EvolvedFireSpider";
        case 1:
            return "GalaxySpace.EvolvedFireCreeper";
        case 2:
            return "GalaxySpace.EvolvedFireSkeleton";
        case 3:
            return "GalaxySpace.EvolvedFireBlaze";
        default:
            return "GalaxySpace.EvolvedFireCreeper";
        }
    }
