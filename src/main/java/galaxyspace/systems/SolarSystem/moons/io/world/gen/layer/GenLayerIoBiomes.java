...
{
	protected BiomeGenBase[] commonBiomes = { GSBiomeGenBase.GSSpace, GSBiomeGenBase.GSSpaceLowHills/* GSBiomeGenBase.GSSpaceLowPlains */};
	protected BiomeGenBase[] rareBiomes = { GSBiomeGenBase.GSSpace };

	public GenLayerIoBiomes(long seed, GenLayer genlayer)
	{
		super(seed);
		this.parent = genlayer;
	}

	public GenLayerIoBiomes(long seed)
	{
		super(seed);
	}
