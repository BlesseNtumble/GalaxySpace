package galaxyspace.systems.SolarSystem.moons.io.render.tile;
...
public class TileEntityIoTreasureChestRenderer extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX + ":" + "textures/model/ioTreasureChest.png");
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX + ":" + "textures/model/ioLargeTreasureChest.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityIoTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				((IoBlockT5TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			else
			{
				...
				this.bindTexture(this.treasureLargeChestTexture);
			}
	...
	{
		this.renderGCTileEntityTreasureChestAt((TileEntityIoTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}