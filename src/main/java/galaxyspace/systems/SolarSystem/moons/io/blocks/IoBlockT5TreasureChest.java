...
public class IoBlockT5TreasureChest extends BlockContainer implements ITileEntityProvider, IBlockShiftDesc
{
	private final Random random = new Random();

	public IoBlockT5TreasureChest(String name)
	{
		super(Material.rock);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "solarsystem/io/ioTreasureChest");
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5)
	{
		...
		final TileEntityIoTreasureChest var6 = (TileEntityIoTreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	{
		final TileEntityIoTreasureChest var7 = (TileEntityIoTreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else
		{
			if (par1World.getBlock(par2 - 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityIoTreasureChest) par1World.getTileEntity(par2 - 1, par3, par4), (IInventory) var10);
			}

			if (par1World.getBlock(par2 + 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityIoTreasureChest) par1World.getTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlock(par2, par3, par4 - 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityIoTreasureChest) par1World.getTileEntity(par2, par3, par4 - 1), (IInventory) var10);
			}

			if (par1World.getBlock(par2, par3, par4 + 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityIoTreasureChest) par1World.getTileEntity(par2, par3, par4 + 1));
			}
	...
	{
		return new TileEntityIoTreasureChest();
	}
    ...
    {
    	return GCCoreUtil.translate("tile.tier5chest.description");
    }
