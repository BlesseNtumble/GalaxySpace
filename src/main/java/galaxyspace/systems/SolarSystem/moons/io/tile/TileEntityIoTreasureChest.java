...
public class TileEntityIoTreasureChest extends TileEntityAdvanced implements IInventory, IKeyable, IPacketReceiver
{
     ...
     */
    public TileEntityIoTreasureChest adjacentChestXPos, adjacentChestXNeg, adjacentChestZPos, adjacentChestZNeg;
    ...
    public TileEntityIoTreasureChest()
    {
        this(5);
    }

    public TileEntityIoTreasureChest(int tier)
    {
        this.tier = tier;
    }
    ...
    private void func_90009_a(TileEntityIoTreasureChest par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            if (this.checkChestBlock(this.xCoord - 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXNeg = (TileEntityIoTreasureChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.checkChestBlock(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityIoTreasureChest) this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.checkChestBlock(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityIoTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.checkChestBlock(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityIoTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean checkChestBlock(int par1, int par2, int par3)
    {
        final Block block = this.worldObj.getBlock(par1, par2, par3);
        return block != null && block instanceof IoBlockT5TreasureChest;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof IoBlockT5TreasureChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
