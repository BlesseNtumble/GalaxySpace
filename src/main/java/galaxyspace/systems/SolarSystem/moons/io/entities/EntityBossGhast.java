...
public class EntityBossGhast extends EntityFlying implements IEntityBreathable, IBossDisplayData, IRangedAttackMob, IBoss
{
	...
	protected void updateEntityActionState()
    {
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity(this) < var9 * var9)
        {
            ...
            if (this.canEntityBeSeen(this.targetedEntity))
            {
                ...
                {
                	if(this.rand.nextInt(5) == 1) this.mode = true;
                    ...
                    var17.posY = this.posY + (double)(this.height / 5.0F) + 0.5D;
                ...
                if(this.count == 8) this.mode = false;
            }
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTicks == 200 && !this.worldObj.isRemote)
        {
            ...
            {
                if (tile instanceof TileEntityIoTreasureChest)
                {
                    ...
                    TileEntityIoTreasureChest chest = (TileEntityIoTreasureChest) tile; 
            ...
            this.entityDropItem(new ItemStack(GSItems.TierKeys, 1, 1), 0.5F);
    ...
    {
        this.func_82209_a(par1, par2EntityLivingBase.posX, par2EntityLivingBase.posY + par2EntityLivingBase.getEyeHeight() / 2.0D, par2EntityLivingBase.posZ);
    }
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6)
    {
        ...
        double d7 = par4 - d4;
        double d8 = par6 - d5;
        EntityLargeFireball entityfireball = new EntityLargeFireball(this.worldObj, this, d6 * 0.5D, d7 * 0.5D, d8 * 0.5D);

        entityfireball.posY = d4;
        entityfireball.posX = d3;
        entityfireball.posZ = d5;
