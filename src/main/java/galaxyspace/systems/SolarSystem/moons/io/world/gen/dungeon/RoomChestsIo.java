...
public class RoomChestsIo extends GSDungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomChestsIo(GSMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public void generate(Block[] chunk, byte[] meta, int cx, int cz)
    {
        ...
        if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, Blocks.chest, 0))
        {
            ...
            {
            	this.placeBlock(chunk, meta, hx + 1, this.posY + o, hz, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx + 1, this.posY + o, hz + 1, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx + 1, this.posY + o, hz - 1, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx - 1, this.posY + o, hz, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx - 1, this.posY + o, hz + 1, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx - 1, this.posY + o, hz - 1, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx, this.posY + o, hz + 1, cx, cz, block, 0);
                this.placeBlock(chunk, meta, hx, this.posY + o, hz - 1, cx, cz, block, 0);
            }
        }
    }
