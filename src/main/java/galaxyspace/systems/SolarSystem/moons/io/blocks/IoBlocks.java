...
public class IoBlocks extends Block implements ISortableBlock{
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random rand)
    {
		...
		{
			if(!world.isBlockNormalCube(pos.up(), false) && world.getBlockState(pos.down()).getMaterial() == Material.LAVA && !world.isBlockNormalCube(pos.up(), true) && world.rand.nextInt(4) == 0)
			{
