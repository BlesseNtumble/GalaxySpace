...
public class EuropaBlockUWGeyser extends Block implements IEnergyGeyser{
	...
	public EuropaBlockUWGeyser() {
		...
		this.setTranslationKey("europa_uwgeyser");
    ...
    public void randomDisplayTick(IBlockState stateIn, World world, BlockPos pos, Random rand)
    {
		...
		if(world.getBlockState(pos.down()).getBlock() == FluidRegistry.WATER.getBlock()) {
	    	if(world.isAirBlock(new BlockPos(pos.getX(), pos.getY() + 1, pos.getZ())) || world.getBlockState(new BlockPos(pos.getX(), pos.getY() + 1, pos.getZ())).getBlock() == Blocks.SNOW_LAYER) {
	    		  	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D, 0.6D * gravity, 0.0D ), new Object [] { 50 , 5, false, new Vector3(1.0F, 1.0F, 1.0F), 1.0D} );
			    	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D, 0.6D * gravity, 0.0D), new Object [] { 50, 5, false, new Vector3(1.0F, 1.0F, 1.0F), 1.0D } );
			    	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D, 0.6D * gravity, 0.0D), new Object [] { 50, 5, false, new Vector3(1.0F, 1.0F, 1.0F), 1.0D } );
			    	
			    	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D + 0.03D, 0.6D * gravity, 0.0D + 0.03D), new Object [] { 160 , 17, true, new Vector3(1.0F, 1.0F, 1.0F), 1.0D} );
			    	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D, 0.6D * gravity, 0.0D), new Object [] { 160, 17, true, new Vector3(1.0F, 1.0F, 1.0F), 1.0D } );
			    	GalaxySpace.proxy.spawnParticle("waterbubbles", new Vector3(pos.getX() + rand.nextDouble(), pos.getY() + 1.0D + rand.nextDouble(), pos.getZ() + rand.nextDouble()), new Vector3(0.0D - 0.03D, 0.6D * gravity, 0.0D - 0.03D), new Object [] { 160, 17, true, new Vector3(1.0F, 1.0F, 1.0F), 1.0D } );
