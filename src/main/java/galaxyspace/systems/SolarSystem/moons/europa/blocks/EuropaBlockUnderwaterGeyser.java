...
public class EuropaBlockUnderwaterGeyser extends Block
{
    ...
    {
        super(Material.rock);
        this.setBlockName("EuropaUnderwaterGeyser");
    ...
    {
        BlockIconFront = par1IconRegister.registerIcon("ice_packed");
        BlockIconSide = par1IconRegister.registerIcon("ice_packed");
        BlockIconTop = par1IconRegister.registerIcon(GalaxySpace.ASSET_PREFIX + ":" + "solarsystem/europa/europauwgeyser");
    }
