...
public class WorldProviderEuropa extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace{
    ...
    public boolean canSpaceshipTierPass(int tier) {
        ...
        return tier >= SolarSystemBodies.europaJupiter.getTierRequirement();
