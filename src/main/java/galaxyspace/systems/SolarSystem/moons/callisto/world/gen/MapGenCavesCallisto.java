...
public class MapGenCavesCallisto
                    ...
                    for (int localY = j2; localY < k2; ++localY) {
                        ...
                        for (int localX = l1; localX < i2; ++localX) {
                            ...
                            for (int localZ = l2; localZ < i3; ++localZ) {
                                ...
                                if (blockIdArray[coords] == GSBlocks.CallistoBlocks && metaArray[coords] == 0 && random.nextInt(25) == 0) {
                                    blockIdArray[coords] = Blocks.air;
                                    continue;
                                }
                                if (blockIdArray[coords] != GSBlocks.CallistoBlocks || metaArray[coords] != 1) continue;
                                blockIdArray[coords] = Blocks.air;
                            }
                        }
                    }
