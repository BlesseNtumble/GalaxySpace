...
public class GSOreGenOtherMods
{
    ...
    static
    {
        for (final String str : GSConfigCore.oregenIDs)
        {
            try
            {
            	...
            	if (slash >= 0)
            	{
            		...
            		else if (params.contains("ONLYPHOBOS")) dim = 3;
            		else if (params.contains("ONLYDEIMOS")) dim = 4;
            		else if (params.contains("ONLYEUROPA")) dim = 5;
            		else if (params.contains("ONLYIO")) dim = 6;
            		else if (params.contains("ONLYENCELADUS")) dim = 7;
            		else if (params.contains("ONLYVENUS")) dim = 8;
            		else if (params.contains("ONLYMERCURY")) dim = 9;
            		else if (params.contains("ONLYCERES")) dim = 10;
    ...
    public static void addOre(Block block, int meta, int rarity, int depth, int clumpSize, boolean extraRandom, int dim)
    {
    	...
    	GSOreGenOtherMods.data.add(ore);
    }
...
*/
    	...
    	for (OreGenData ore : GSOreGenOtherMods.data)
    	{
