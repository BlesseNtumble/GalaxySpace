...
public class EntityCustomCargoRocket extends EntityAutoRocket implements IRocketType, IWorldTransferCallback {
	...
	public EntityCustomCargoRocket(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
    ...
    public void onUpdate()
    {
        ...
        {
        	fluidTank.setFluid(new FluidStack(GSFluids.Helium3, 1535));
        }
    }
            ...
            if (this.targetDimension != GCCoreUtil.getDimensionID(this.world))
            {
                ...
                if (targetDim != null && targetDim.world instanceof WorldServer)
                {
                    ...
                    if (e instanceof EntityCustomCargoRocket)
                    {
                        ...
                        ((EntityCustomCargoRocket) e).setLaunchPhase(EnumLaunchPhase.LANDING);
    ...
    public boolean processInitialInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        {
        	player.sendMessage(new TextComponentString(this.fluidTank.getFluid().getLocalizedName() + ": " + this.fluidTank.getFluidAmount()));
    ...
    public int getSizeInventory()
    {
        ...
        return 0;//this.rocketType.getInventorySpace();
    }
