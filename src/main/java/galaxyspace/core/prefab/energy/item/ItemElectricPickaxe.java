...
public class ItemElectricPickaxe extends ItemPickaxe implements IItemElectric
{
	public float transferMax;
	private float maxPower;
	public static IIcon[] icons = new IIcon[2];
	
	public ItemElectricPickaxe(String name, ToolMaterial material, float maxPower)
    {
        super(material);
