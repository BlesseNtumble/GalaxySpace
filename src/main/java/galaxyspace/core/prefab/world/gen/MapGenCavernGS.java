...
public class MapGenCavernGS extends MapGenBaseMeta
{
	private IBlockState vines;
	private IBlockState[] blocks;
	public MapGenCavernGS(IBlockState vine, IBlockState... state)
	{
		this.vines = vine;
		this.blocks = state;
	}
                            ...
                            if (var59 * var59 + var46 * var46 < 1.0D)
                            {
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            IBlockState block = primer.getBlockState(var42, var50, var45);

                                            boolean flag = false;
                                            for(IBlockState state : this.blocks)
                                ...
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            ...
                                            if (Blocks.AIR == block)
                                            {
                                                if (blockAbove == this.blocks[2].getBlock() && this.rand.nextInt(200) == 0)
                                                {
                                                    int modifier = 0;

                                                    while (Blocks.AIR == block && var50 + modifier > 0)
                                                    {
                                                        primer.setBlockState(var42, var50 + modifier, var45, this.vines.getBlock().getStateFromMeta(Math.abs(modifier) % 3));
                                                        modifier--;
