...
public class GSPersistantInventoryCrafting extends InventoryCrafting
{
    ...
    public Container gs_eventHandler;

    public GSPersistantInventoryCrafting()
    {
        super(null, 3, 3);
        int k = 9;
    ...
    public ItemStack decrStackSize(int index, int count)
    {
        ...
        {
            this.markDirty();
            if (this.gs_eventHandler != null)
            {
                this.gs_eventHandler.onCraftMatrixChanged(this);
            }
        }
