...
public class GSEntityMeteor extends Entity
{
    public EntityLiving shootingEntity;
    public int size;

    public GSEntityMeteor(World world)
    {
        super(world);
        this.setSize(1.0F, 1.0F);
    }

    public GSEntityMeteor(World world, double x, double y, double z, double motX, double motY, double motZ, int size)
    {
        this(world);
        this.size = size;
        this.setSize(1.0F, 1.0F);
    ...
    protected void onImpact(MovingObjectPosition movingObjPos)
    {
        if (!this.worldObj.isRemote)
        {
            if (movingObjPos != null)
            {
                ...
                {
                    movingObjPos.entityHit.attackEntityFrom(GSEntityMeteor.causeMeteorDamage(this, this.shootingEntity), ConfigManagerCore.hardMode ? 12F : 6F);
                }
            }
    ...
    public static DamageSource causeMeteorDamage(GSEntityMeteor par0EntityMeteor, Entity par1Entity)
    {
