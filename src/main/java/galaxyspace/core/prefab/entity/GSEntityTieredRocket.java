...
public abstract class GSEntityTieredRocket extends EntityAutoRocket implements IRocketType, IDockable, IInventory, IWorldTransferCallback, ICameraZoomEntity
{
    ...
    public GSEntityTieredRocket(World par1World)
    {
        super(par1World);
    ...
    public GSEntityTieredRocket(World world, double posX, double posY, double posZ)
    {
    ...
    private void initiatePlanetsPreGen(int cx, int cz)
    {
        ...
        if (this.destinationFrequency == -1 && !GSEntityTieredRocket.preGenInProgress)
        {
            ...
            if (toPreGen.size() > 0)
            {
                ...
                GSEntityTieredRocket.preGenInProgress = true;
            }
        }
        else
        {
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.preGenIterator != null)
            {
                ...
                {
                    this.preGenIterator = null;
                    GSEntityTieredRocket.preGenInProgress = false;
                }
            }
        }
    ...
    public void decodePacketdata(ByteBuf buffer)
    {
        ...
        this.fuelTank.setFluid(new FluidStack(this.FuelType(), buffer.readInt()));
    ...
    public Fluid FuelType()
    {
    	return GalacticraftCore.fluidOil;
    }
}
