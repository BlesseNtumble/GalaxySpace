...
public class GSConfigSchematics
{
    ...
    public static int idSchematicPortableNuclear = 17;
    ...
    public static void syncConfig(boolean load)
    {
        ...
        try
        {
            ...
            prop.comment = "Schematic ID for Cone (Rocket Detail), must be unique.";
            ...
            prop.comment = "Schematic ID for Body (Rocket Detail), must be unique.";
            ...
            prop.comment = "Schematic ID for Engine (Rocket Detail), must be unique.";
            ...
            prop.comment = "Schematic ID for Booster (Rocket Detail), must be unique.";
            ...
            prop.comment = "Schematic ID for Fins (Rocket Detail), must be unique.";
            ...
            prop.comment = "Schematic ID for Oxygen PPE Tank, must be unique.";
            prop.setLanguageKey("gc.configgui.idSchematicOxTank");
            idSchematicOxTank = prop.getInt(16);
            propOrder.add(prop.getName());
            
            prop = config.get(Constants.CONFIG_CATEGORY_SCHEMATIC, "idSchematicPortableNuclear", 17);
            prop.comment = "Schematic ID for Portable Nuclear Reactor, must be unique.";
            prop.setLanguageKey("gc.configgui.idSchematicPortableNuclear");
            idSchematicPortableNuclear = prop.getInt(17);
            propOrder.add(prop.getName());
