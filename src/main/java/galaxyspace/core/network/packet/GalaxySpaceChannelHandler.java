...
public class GalaxySpaceChannelHandler extends FMLIndexedMessageToMessageCodec<IPacket>
{
    private EnumMap<Side, FMLEmbeddedChannel> channels;

    private GalaxySpaceChannelHandler()
    {
        this.addDiscriminator(0, GSPacketSimple.class);
    }

    public static GalaxySpaceChannelHandler init()
    {
        GalaxySpaceChannelHandler channelHandler = new GalaxySpaceChannelHandler();
        channelHandler.channels = NetworkRegistry.INSTANCE.newChannel(GalaxySpace.MODID, channelHandler, new GalaxySpacePacketHandler());
