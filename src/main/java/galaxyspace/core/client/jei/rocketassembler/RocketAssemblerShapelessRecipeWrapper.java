...
public class RocketAssemblerShapelessRecipeWrapper implements IRecipeWrapper
{
    @Nonnull
    private final ShapelessOreRecipeGC recipe;
    private final IStackHelper stackHelper;

    public RocketAssemblerShapelessRecipeWrapper(IStackHelper stackhelper, @Nonnull ShapelessOreRecipeGC recipe)
    {
        this.recipe = recipe;
    ...
    {
        if (GalaxySpaceJEI.hidden.contains(this))
        {
