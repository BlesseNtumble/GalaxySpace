...
public class BoosterRecipeCategory implements IRecipeCategory
{
    ...
    public BoosterRecipeCategory(IGuiHelper guiHelper)
    {
    ...
    {
        return GSRecipeCategories.BOOSTER;
    }
    ...
    public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
        ...
        int xOffset = 12;
        int yOffset = 10;
        itemstacks.init(0, true, 13 + xOffset, 25+16*2 + yOffset);
        itemstacks.init(1, true, 13 + xOffset, 25+16*3 + yOffset);
        itemstacks.init(2, true, 13 + xOffset, 25+16*4 + yOffset);
        
        itemstacks.init(3, true, 29 + xOffset, 25+16 + yOffset);
        itemstacks.init(4, true, 29 + xOffset, 25+16*2 + yOffset);
        itemstacks.init(5, true, 29 + xOffset, 25+16*3 + yOffset);        
        itemstacks.init(6, true, 29 + xOffset, 25+16*4 + yOffset);
        ...
        itemstacks.init(10, false, 143, 118);
