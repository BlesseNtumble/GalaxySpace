...
public class BakedModelBrightFour extends BakedModelDelegate {
	...
	private TextureAtlasSprite sprite, sprite1;
	private List<BakedQuad> cache;
	
    public BakedModelBrightFour(IBakedModel base, String texture_side, String texture_top, int bright, double color) {
        super(base);
        this.bright = bright;
        this.alpha = color;
        sprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(texture_side.toString());
        sprite1 = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(texture_top.toString());
    ...
    public List<BakedQuad> getQuads(@Nullable IBlockState state, @Nullable EnumFacing side, long rand) {    	
        ...
        if(state.getValue(Barnarda_C_Logs.LOG_AXIS) == Barnarda_C_Logs.EnumAxis.X)
		{
        	...
        	//UP
        	quads.add(createQuad(state, new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(0.0D, 1.0D, 0.0D), this.base.getParticleTexture(), false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			
        	//RIGHT
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), this.base.getParticleTexture(), false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
						
			//LEFT
			quads.add(createQuad(state, new Vec3d(1.0D, 0.0D, 0.0D), new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 0.0D), this.base.getParticleTexture(), false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			
			
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(0.0D, 0.0D, 0.0D), this.sprite1, false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			quads.add(createQuad(state, new Vec3d(1.0D, 0.0D, 0.0D), new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), this.sprite1, false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
	
			
			//DOWN
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(1.0D, 0.0D, 0.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(0.0D, 0.0D, 1.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));
			//UP
			quads.add(createQuad(state, new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));			
			//RIGHT
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));
			//LEFT
			quads.add(createQuad(state, new Vec3d(1.0D, 0.0D, 0.0D), new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 0.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));
        ...
        else if(state.getValue(Barnarda_C_Logs.LOG_AXIS) == Barnarda_C_Logs.EnumAxis.Z)
		{
			...
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), this.sprite1, false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			
			quads.add(createQuad(state, new Vec3d(1.0D, 0.0D, 0.0D), new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 0.0D), this.sprite1, false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			
			//RIGHT
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 0.0D), this.base.getParticleTexture(), false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			//LEFT
			quads.add(createQuad(state, new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(1.0D, 0.0D, 0.0D), this.base.getParticleTexture(), false, 0, new Vec3d(1.0D, 1.0D, 1.0D), 0));
			...
			//RIGHT
			quads.add(createQuad(state, new Vec3d(0.0D, 0.0D, 0.0D), new Vec3d(0.0D, 0.0D, 1.0D), new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(0.0D, 1.0D, 0.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));
			//LEFT
			quads.add(createQuad(state, new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(1.0D, 0.0D, 1.0D), new Vec3d(1.0D, 0.0D, 0.0D), sprite, true, this.bright, new Vec3d(this.alpha, this.alpha, this.alpha), 0));
