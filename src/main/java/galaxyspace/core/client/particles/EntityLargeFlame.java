...
public class EntityLargeFlame extends EntityFX {
   ...
   public EntityLargeFlame(World par1World, Vector3 position, Vector3 motion) 
   {
      ...
      super.particleScale = (float)((double)super.particleScale * 4.0D);
      this.flameScale = super.particleScale;
      super.particleRed = super.particleGreen = super.particleBlue = 1.0F;
      super.particleMaxAge = (int)(0.1D / (Math.random() * 0.8D + 0.2D)) + 4;
      this.setParticleTextureIndex(48); //84 - пар квадратами
   }
