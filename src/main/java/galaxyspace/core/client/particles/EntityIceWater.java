...
public class EntityIceWater extends EntityFX {
   ...
   public EntityIceWater(World par1World, Vector3 position, Vector3 motion) 
   {
      ...
      this.setParticleTextureIndex(5); //84 - пар квадратами
   }
