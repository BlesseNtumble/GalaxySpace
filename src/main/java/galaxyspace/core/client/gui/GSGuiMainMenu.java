...
public class GSGuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation mainmenu = new ResourceLocation(GalaxySpace.ASSET_PREFIX + ":" + "textures/gui/mainmenu.png");
    ...
    public void initGui()
    {
        this.viewportTexture = new DynamicTexture(512, 512);
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        if(GSThreadVersionCheck.newversion) this.buttonList.add(new GSGuiButton(3, i / 2, 94, 150, 20, I18n.format("menu.update", new Object[0])));
        ...
        this.buttonList.add(new GSGuiButton(7, 5, this.height - 180, 60, 20, I18n.format("VK Group", new Object[0])));
        this.buttonList.add(new GSGuiButton(8, 5, this.height - 157, 60, 20, I18n.format("Discord", new Object[0])));
        this.buttonList.add(new GSGuiButton(9, 5, this.height - 134, 60, 20, I18n.format("GC Forum", new Object[0])));
...
*/
    ...
    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_)
    {
        ...
        float f2 = (float)this.height * f1 / 512.0F;
        float f3 = (float)this.width * f1 / 512.0F;
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
    	...
    	Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(0 + 0, 0 + height, zLevel, 0,1);
		tessellator.addVertexWithUV(0 + width, 0 + height, zLevel, 1, 1);
		tessellator.addVertexWithUV(0 + width, 0 + 0, zLevel, 1,0);
		tessellator.addVertexWithUV(0 + 0, 0 + 0, zLevel, 0, 0);
		tessellator.draw();
		/*if(this.height > 400 && this.width > 400)
		{
			...
			mc.renderEngine.bindTexture(mainmenu);
			tessellator.startDrawingQuads();
			tessellator.addVertexWithUV(60 + 0, height, zLevel, 0,1);
			tessellator.addVertexWithUV(0 + 180, height, zLevel, 1, 1);
			tessellator.addVertexWithUV(0 + 180, 0 + 0, zLevel, 1,0);
			tessellator.addVertexWithUV(60 + 0, 0 + 0, zLevel, 0, 0);
			tessellator.draw();
        ...
        GL11.glColor4f(0.0F, 0.6F, 1.0F, 0.8F);
        this.drawTexturedModalRect(-15, this.height - 15 * brandings.size(), 189, 112, 299, 60, 222, 374 / 2 - 10, true, false, 512, 512);
        this.drawTexturedModalRect(this.width - 245, this.height - 35, 194, 224 / 2 - 30, 299, 60, 222, 374 / 2 - 50, false, false, 512, 512);
        this.drawTexturedModalRect(this.width - 59, this.height - 53, 65, 224 / 2 - 30, 359, 60, 60, 374 / 2 - 50, false, false, 512, 512);
       ...
       // this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, -512);
        ...
        this.drawString(this.fontRendererObj, "Ver. " + GalaxySpace.VERSION, this.width - this.fontRendererObj.getStringWidth(GalaxySpace.VERSION) - 35, this.height / 2 - 53, -1);
