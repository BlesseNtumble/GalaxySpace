...
public class GSGuiSchematicInput extends GuiContainerGC implements ISchematicResultPage
{
    private static final ResourceLocation schematicInputTexture = new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/gui/schematic_page_GS.png");

    private int pageIndex;

    public GSGuiSchematicInput(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
    ...
    {
        this.fontRendererObj.drawString(EnumColor.WHITE + GCCoreUtil.translate("gui.message.addnewsch.name"), 7, -25, 4210752);
        this.fontRendererObj.drawString(GCCoreUtil.translate("container.inventory"), 15, 58, 4210752);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GSGuiSchematicInput.schematicInputTexture);
