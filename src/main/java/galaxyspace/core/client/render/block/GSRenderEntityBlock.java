...
import galaxyspace.core.prefab.entity.GSEntityBlock;
...
public class GSRenderEntityBlock extends Render {

	public static GSRenderEntityBlock INSTANCE = new GSRenderEntityBlock();
	protected RenderBlocks renderBlocks;

	private GSRenderEntityBlock() {
	...
	public void doRender(Entity entity, double x, double y, double z, float f, float f1) {
		doRenderBlock((GSEntityBlock) entity, x, y, z);
	}

	public void doRenderBlock(GSEntityBlock entity, double x, double y, double z) {
		if (entity.isDead) {
			return;
		}
