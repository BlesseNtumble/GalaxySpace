...
public class ItemRenderKey implements IItemRenderer
{
    private final ResourceLocation[] treasureChestTexture =
    {
    		new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/ceresTreasureChest.png"),
    		new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/ioTreasureChest.png"),
    		new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/enceladusTreasureChest.png"),
    		new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/proteusTreasureChest.png"),
    		new ResourceLocation(GalaxySpace.ASSET_PREFIX, "textures/model/plutoTreasureChest.png")
    };

    ModelKey keyModel = new ModelKey();

    public ItemRenderKey()
    {
    ...
    private void renderKey(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ, Object... data)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.treasureChestTexture[item.getItemDamage()]);
